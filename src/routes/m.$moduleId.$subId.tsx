...
function SubModuleDetail() {
  ...
  const [anomalies11, setAnomalies11] = useState([
    {
      id: 1,
      title: "BOM missing for Item Code MS-218",
      severity: "HIGH",
      system: "SAP B1 ERP",
      resolved: false,
      cta: "Create BOM",
    ...
    {
      id: 2,
      title: "CRCA Sheet 1.2mm stock: 0 kg — required by 3 jobs",
      severity: "CRITICAL",
      system: "SAP B1 ERP",
      resolved: false,
      cta: "Raise PO",
    ...
    {
      id: 3,
      title: "Line 4 Night Shift — no workforce assigned",
      severity: "HIGH",
      system: "HRMS / eSSL",
      resolved: false,
      cta: "Assign Workers",
    ...
    {
      id: 4,
      title: "WIP Job JC-4799: no linked job card found",
      severity: "MEDIUM",
      system: "Custom MES",
      resolved: false,
      cta: "Investigate",
    ...
    {
      id: 5,
      title: "No sync from SAP B1 ERP for 52 minutes",
      severity: "HIGH",
      system: "SAP B1 ERP",
      resolved: false,
  ...
  const triggerSync11 = () => {
    ...
    toast.loading(
      "Establishing API tunnels to SAP B1 Service Layer and ZKTeco biometric SQL node...",
    );
    setTimeout(() => {
  ...
  const resolveAnomaly11 = (id: number, cta: string) => {
    setAnomalies11((prev) => prev.map((a) => (a.id === id ? { ...a, resolved: true } : a)));
  ...
  // ----------------------------------------------------
  const [priorityRule, setPriorityRule] = useState<"Strategic" | "EDD" | "FIFO" | "Setup">(
    "Strategic",
  );
  const [scheduleWeek, setScheduleWeek] = useState("Week of 22–26 Jan 2025");
  const [schedulingStatus, setSchedulingStatus] = useState<"idle" | "optimizing" | "complete">(
    "idle",
  );
  ...
  const [jobsList12, setJobsList12] = useState([
    ...
    },
    {
      ...
      line: "Line 1 — CNC Complex",
      days: "Mon–Thu",
      qty: 2500,
      priority: 92,
      status: "⚠️ Capacity Collision",
      color: "danger",
    },
    {
      id: "JC-4823",
      item: "PC-112",
      customer: "Maruti Ancillaries",
      line: "Line 2 — Assembly",
      days: "Mon–Tue",
      qty: 800,
      priority: 71,
      status: "On Schedule",
    ...
    },
    {
      ...
      qty: 400,
      priority: 88,
      status: "⚠️ Overload Stoppage Risk",
      color: "danger",
    },
  ]);
  ...
  const runScheduler = () => {
    ...
    toast.loading(
      "AI scheduling engine is mapping order profiles, machine buffers, and inventory queues...",
    );
    setTimeout(() => {
  ...
  const [centersData, setCentersData] = useState([
    {
      ...
      status: "Overloaded",
      trend: "up",
      ordersAtRisk: ["JC-4819", "JC-4823"],
      forwardLoad: "102% (Wk 3)",
    },
    {
      ...
      status: "High Load",
      trend: "stable",
      ordersAtRisk: ["JC-4826"],
      forwardLoad: "80% (Wk 3)",
    },
    {
      name: "Stamping Line 3",
      type: "Heavy Press Yard",
      mon: 61,
      tue: 65,
      wed: 58,
      thu: 63,
    ...
    },
    {
      ...
      status: "High Load",
      trend: "up",
      ordersAtRisk: ["JC-4824"],
      forwardLoad: "92% (Wk 3)",
    },
    {
      name: "Painting Line 5",
      type: "Finishing Pod",
      mon: 72,
      tue: 68,
      wed: 74,
  ...
  const applyOvertime = () => {
    ...
    toast.success(
      "Overtime schedule approved (+4 hrs). CNC Line 1 capacity increased and balanced.",
    );
  };
  ...
  const [rosterGaps, setRosterGaps] = useState([
    {
      ...
      gap: 2,
      status: "Critical",
      absents: "Ramesh Kumar (Grade A Operator), Vijay Sharma (Helper)",
      solved: false,
    },
    {
      ...
      gap: 1,
      status: "Minor Gap",
      absents: "Priya Mehta (Operator)",
      solved: false,
    },
    {
      line: "Stamping Line 3",
      req: 6,
      pres: 6,
      gap: 0,
    ...
    },
    {
      ...
      gap: 2,
      status: "Understaffed",
      absents: "Arun Patel, Deepak Joshi",
      solved: false,
    },
    {
      line: "Painting Line 5",
      req: 5,
      pres: 5,
      gap: 0,
      status: "Fully Staffed",
    ...
    },
    {
      ...
      gap: 1,
      status: "Minor Gap",
      absents: "Suresh Nair (Quality Auditor)",
      solved: false,
    },
  ]);
  const [replacementsLog, setReplacementsLog] = useState([
    {
      id: 1,
      absent: "Ramesh Kumar",
      role: "Grade A CNC Operator",
      options: ["Kiran Shah (Grade A, Packing)", "Dinesh Patel (Grade B, Line 3)"],
      status: "unresolved",
    },
    {
      id: 2,
      ...
      options: ["Ajay Trivedi (Line 2 spare capacity)"],
      status: "unresolved",
    },
  ]);
  ...
  const confirmReallocation = (logId: number, subName: string) => {
    setReplacementsLog((prev) =>
      prev.map((item) =>
        item.id === logId ? { ...item, status: `Reallocated: ${subName}` } : item,
      ),
    );
      ...
      prev.map((g) => {
        if (g.line === "CNC Line 1") {
          ...
          return {
            ...
            pres: g.pres + 1,
            status:
              updatedGap === 0 ? "Fully Staffed" : updatedGap === 1 ? "Minor Gap" : "Critical",
          };
        }
        return g;
      }),
  ...
  const [mrpData, setMrpData] = useState([
    ...
    {
      code: "RM-ZINC-001",
      desc: "Zinc Coating Powder",
      unit: "KG",
      stock: 180,
      required: 420,
      shortfall: 240,
      status: "Critical",
      vendor: "Shah Chemicals",
      rate: 340,
      leadTime: 3,
    },
    {
      code: "RM-MSR-20",
      desc: "MS Round Bar 20mm",
      unit: "KG",
      stock: 0,
      required: 800,
      shortfall: 800,
    ...
    {
      code: "RM-MIG-001",
      desc: "MIG Welding Wire",
      unit: "Spools",
      stock: 45,
      required: 80,
      shortfall: 35,
      status: "Reorder Due",
      vendor: "Krishna Fasteners",
      rate: 480,
      leadTime: 6,
    },
    {
      code: "RM-PRIMER-RED",
      desc: "Primer Coat Red",
      unit: "Litres",
      stock: 120,
      required: 200,
      shortfall: 80,
      status: "Reorder Due",
      vendor: "Bharat Lubricants",
      rate: 180,
      leadTime: 2,
    },
    {
      code: "RM-CRCA-1.5",
      desc: "CRCA Sheet 1.5mm",
      unit: "KG",
      stock: 5200,
      required: 380,
      shortfall: 0,
    ...
    {
      code: "RM-ALU-2.0",
      desc: "Aluminium Sheet 2mm",
      unit: "KG",
      stock: 1800,
      required: 1400,
      shortfall: 0,
      status: "Normal",
      vendor: "Arvind Metals",
      rate: 220,
      leadTime: 4,
    },
    {
      ...
      shortfall: 3600,
      status: "Reorder Due",
      vendor: "Patel Packaging",
      rate: 4.2,
      leadTime: 2,
    },
    {
      code: "RM-SPRING-STEEL",
      desc: "Spring Steel Strip",
      unit: "KG",
      stock: 900,
      required: 600,
      shortfall: 0,
  ...
  const handleRaisePO = (code: string) => {
    ...
    toast.success(
      `Purchase Requisition successfully pushed to SAP B1. Draft PO routed to ${selectedMaterial.vendor}.`,
    );
  };
  ...
  const handleRaiseAllUrgent = () => {
    ...
    toast.success(
      "Bulk action complete: All urgent materials purchase requisitions successfully compiled and routed to SAP B1.",
    );
  };
  ...
  const [reportGenStatus, setReportGenStatus] = useState<"idle" | "generating" | "complete">(
    "idle",
  );
  ...
  const handleGenReport17 = () => {
    ...
    toast.loading(
      "AI compiler is loading database structures, weekly charts, and shift OEE datasets...",
    );
    setTimeout(() => {
      setReportGenStatus("complete");
      toast.dismiss();
      toast.success(
        "Executive PDF planning report generated and queued for WhatsApp/Email distribution.",
      );
    }, 2000);
  };
  ...
  const [pendingPRs21, setPendingPRs21] = useState([
    {
      id: "PR-2024-1047",
      material: "CRCA Sheet 1.2mm",
      qty: 3000,
      unit: "kg",
      requiredBy: "25 Jan",
      triggeredBy: "M1.5 MRP Agent",
      value: 204000,
      priority: "URGENT",
    },
    {
      id: "PR-2024-1048",
      material: "Zinc Coating Powder",
      qty: 500,
      unit: "kg",
      requiredBy: "27 Jan",
      triggeredBy: "M1.5 MRP Agent",
    ...
    {
      id: "PR-2024-1051",
      material: "Cutting Oil (Industrial)",
      qty: 200,
      unit: "litres",
      requiredBy: "3 Feb",
      triggeredBy: "Manual",
  ...
  const [approvedPOs21, setApprovedPOs21] = useState([
    {
      poNumber: "PO-2024-1147",
      vendor: "Mehta Steel Works",
      value: 240720,
      status: "Sent to Vendor",
      confirmed: true,
      date: "22 Jan 2025, 10:14 AM",
    },
  ]);
  ...
  const triggerPO21 = () => {
    ...
    const steps = [
      ...
      "STEP 4 — Approval Check: ₹" +
        (activePR21.value * 1.18).toLocaleString("en-IN") +
        " → requires Purchase Manager approval",
            ...
            setApprovedPOs21((prev) => [
              {
                ...
                vendor: activePR21.material.includes("Steel")
                  ? "Mehta Steel Works"
                  : activePR21.material.includes("Zinc")
                    ? "Shah Chemicals"
                    : "Arvind Metals",
  ...
  const [openPOs22, setOpenPOs22] = useState([
    {
      id: "PO-24-2104",
      vendor: "Mehta Steel Works",
      material: "CRCA Sheet 1.5mm",
      date: "12/06/2026",
      days: 0,
      otd: 94,
      status: "On track",
      lastMsg: "Will deliver on time",
      escalated: false,
      ...
      lastContact: "Today 09:12",
    },
    {
      id: "PO-24-2098",
      vendor: "Jain Polymers",
      material: "Primer Coat Red",
      date: "08/06/2026",
      days: -2,
      otd: 78,
      status: "Delayed 2d",
      lastMsg: "Delayed due to logistics",
      escalated: false,
      transporter: "Safexpress",
      transitStatus: "Delayed",
      risk: "Medium",
      missingDocs: ["Material Test Certificate"],
      avgDelay: 2.1,
      channels: ["whatsapp"],
      lastContact: "Today 10:40",
    },
    {
      id: "PO-24-2091",
      vendor: "Shah Chemicals",
      ...
      otd: 84,
      status: "Dispatched",
      lastMsg: "Dispatched — LR: SC441",
      escalated: false,
      transporter: "Safexpress",
      transitStatus: "In-Transit",
      risk: "Low",
      missingDocs: ["e-Way Bill"],
      avgDelay: 1.5,
      channels: ["whatsapp", "email"],
      lastContact: "Yest. 16:20",
    },
    {
      id: "PO-24-2102",
      vendor: "Patel Packaging",
      ...
      otd: 88,
      status: "On track",
      lastMsg: "Acknowledge — will dispatch soon",
      escalated: false,
      transporter: "TCI Freight",
      transitStatus: "Pending Dispatch",
      risk: "Low",
      missingDocs: ["Tax Invoice"],
      avgDelay: 1.2,
      channels: ["email"],
      lastContact: "Today 08:55",
    },
    {
      id: "PO-24-2108",
      vendor: "Gujarat Bearings",
      material: "MS Round Bar 20mm",
      date: "14/06/2026",
      days: 5,
      otd: 71,
      status: "On track",
      lastMsg: "ETA confirmed",
      escalated: false,
      transporter: "VRL Logistics",
      transitStatus: "In-Transit",
      risk: "Low",
    ...
    },
    {
      ...
      otd: 91,
      status: "Delayed 4d",
      lastMsg: "Waiting for raw material arrival",
      escalated: false,
      transporter: "Gati Cargo",
      transitStatus: "Delayed",
      risk: "High",
      missingDocs: [],
      avgDelay: 0.8,
      channels: ["whatsapp"],
      lastContact: "Today 09:45",
    },
    {
      id: "PO-24-2112",
      vendor: "Krishna Fasteners",
    ...
    },
    {
      ...
      otd: 85,
      status: "Acknowledged",
      lastMsg: "PO received, confirming schedule",
      escalated: false,
      transporter: "TCI Freight",
      transitStatus: "Pending Dispatch",
      risk: "Low",
  ...
  const handleEscalate22 = (poId: string) => {
    setOpenPOs22((prev) =>
      prev.map((p) => (p.id === poId ? { ...p, escalated: true, status: "Escalated" } : p)),
    );
  ...
  // ----------------------------------------------------
  const [scanStatus23, setScanStatus23] = useState<
    "idle" | "uploading" | "extracting" | "complete"
  >("idle");
  ...
  const [invoices24, setInvoices24] = useState([
    {
      ...
      value: 35046,
      status: "Disputed",
      match: "Price deviation +10%",
      due: "24 Feb",
      po: "PO-2024-1151",
      grn: "GRN-2024-447",
      item: "Primer Coat Red",
      qty: 150,
      rate: 198,
      poRate: 180,
    },
    ...
    },
    {
      ...
      value: 44000,
      status: "Pending",
      match: "Item code query",
      due: "21 Feb",
      po: "PO-2024-1148",
      grn: "GRN-2024-442",
      item: "MS Round Bar 20mm",
      qty: 800,
      rate: 55,
      poRate: 55,
    },
  ...
  const handleApproveInvoice24 = (id: string, usePoRate = false) => {
    setInvoices24((prev) =>
      prev.map((inv) =>
        inv.id === id
          ? { ...inv, status: "Approved", match: usePoRate ? "Approved at PO Rate" : "Full match" }
          : inv,
      ),
    );
    toast.success(
      usePoRate
        ? `Invoice approved at approved PO rate (₹${activeInvoice24.poRate}). Disputed amount cleared.`
        : "Invoice approved for booking.",
    );
  };
  ...
  const activeVendor25 =
    vendors25.find((v) => v.id === selectedVendorId25) || vendors25[vendors25.length - 1];
  ...
  const [materials26, setMaterials26] = useState([
    ...
    {
      name: "Zinc Coating Powder",
      std: 330,
      actual: 340,
      variance: "+3.0%",
      trend: "Rising 2 months",
    },
    { name: "Aluminium Sheet 2mm", std: 218, actual: 220, variance: "+0.9%", trend: "Stable" },
    {
      name: "Primer Coat Red",
      std: 180,
      actual: 198,
      variance: "+10.0%",
      trend: "Spike — query raised",
    },
  ]);
  const [cfoReportStatus26, setCfoReportStatus26] = useState<"idle" | "generating" | "done">(
    "idle",
  );

  const activeMaterial26 =
    materials26.find((m) => m.name === selectedMaterialName26) || materials26[4];
  ...
  const [inspections31, setInspections31] = useState([
    ...
    },
    {
      ...
      defects: 3,
      result: "HOLD",
      defectType: "Dimensional — Borderline",
      date: "24 Jan 2025",
      time: "09:10",
      inspector: "Suresh Nair",
    },
  ...
  const [ncrList32, setNcrList32] = useState([
    {
      ...
      product: "MS-204",
      batch: "B-4821",
      defect: "Surface Finish (scratches) + Wall Thickness above USL (3.24mm vs 3.20mm)",
      type: "Surface Finish",
      severity: "Major",
      age: 2,
      owner: "Vijay Sharma",
      status: "In Progress",
      details: "Worn fixture pad on CNC-01 causing micro-vibration",
      containment: "Full lot segregated in Hold Area B",
    },
    {
      id: "NCR-2024-438",
      date: "19 Jan 2025",
      product: "MS-208",
      batch: "B-4809",
      defect: "Hole position deviation on stamped bracket (+0.45mm)",
      type: "Dimensional",
      severity: "Major",
      age: 5,
      owner: "Arun Patel",
      status: "Root Cause Pending",
      details: "Awaiting tooling wear verification reports",
      containment: "Segregated at welding cell",
    },
    {
      id: "NCR-2024-435",
      date: "16 Jan 2025",
      product: "PC-112",
      batch: "B-4801",
      defect: "Burr on casting flange edge exceeding Ra 12.5",
      type: "Surface Finish",
      severity: "Minor",
      age: 8,
      owner: "Priya Mehta",
      status: "Corrective Action Done",
      details: "Deburring cutter replaced on station 4",
      containment: "Manual deburring completed",
    },
    {
      id: "NCR-2024-431",
      date: "12 Jan 2025",
      product: "SP-044",
      batch: "B-4795",
      defect: "Surface scratches on stamped body panel",
      type: "Surface Finish",
      severity: "Major",
      age: 12,
      owner: "Vijay Sharma",
      status: "Overdue",
      details: "Fixture alignment check outstanding",
      containment: "Held in rework cell",
    },
    {
      id: "NCR-2024-428",
      date: "10 Jan 2025",
      product: "MS-212",
      batch: "B-4788",
      defect: "Profile profile deviation on outer chamfer",
      type: "Dimensional",
      severity: "Major",
      age: 14,
      owner: "Arun Patel",
      status: "Overdue",
      details: "CNC offset check pending",
      containment: "100% inspection ordered",
    },
    {
      id: "NCR-2024-422",
      date: "06 Jan 2025",
      product: "PC-118",
      batch: "B-4780",
      defect: "Missing material test certificate from steel supplier",
      type: "Documentation",
      severity: "Minor",
      age: 18,
      owner: "Suresh Nair",
      status: "Awaiting Sign-off",
      details: "Supplier has emailed cert; awaiting upload check",
      containment: "Batch tagged in warehouse",
    },
    {
      id: "NCR-2024-419",
      date: "03 Jan 2025",
      product: "MS-204",
      batch: "B-4774",
      defect: "Orange peel texture on powder coated cover",
      type: "Surface Finish",
      severity: "Minor",
      age: 21,
      owner: "Deepak Joshi",
      status: "Corrective Action Done",
      details: "Oven temperature profile calibrated",
      containment: "Rework completed",
    },
  ]);
  ...
  const [traceType33, setTraceType33] = useState<"Backward" | "Forward" | "Cross-batch">(
    "Backward",
  );
  ...
  const [reports34, setReports34] = useState([
    {
      id: "RPT-2024-ISO-JAN",
      name: "ISO 9001 Management Review",
      period: "Jan 2025",
      date: "31 Jan 23:58",
      pages: 12,
      status: "Approved & Issued",
      recipients: "MD, QA Head, HODs",
    },
    {
      id: "RPT-2024-NCR-JAN",
      name: "NCR Monthly Summary",
      period: "Jan 2025",
      date: "31 Jan 23:59",
      pages: 5,
      status: "Issued",
      recipients: "QA Head, Prod Head",
    },
    {
      id: "RPT-2024-CAPA-W3",
      name: "CAPA Status Report",
      period: "W3 Jan 2025",
      date: "19 Jan 08:00",
      pages: 4,
      status: "Issued",
      recipients: "QA Head, HODs",
    },
    {
      id: "RPT-2024-CAL-JAN",
    ...
    {
      id: "RPT-2024-PPAP-204",
      name: "PPAP — MS-204 (Tata AutoComp)",
      period: "On-demand",
      date: "19 Jan 14:22",
      pages: 18,
      status: "Issued",
      recipients: "Customer QA",
    },
  ]);
  const [selectedReportId34, setSelectedReportId34] = useState("RPT-2024-ISO-JAN");
  const [reportGenStatus34, setReportGenStatus34] = useState<"idle" | "generating" | "complete">(
    "idle",
  );
  ...
  const triggerReportGen34 = () => {
    ...
    setTimeout(() => {
      ...
      setReports34((prev) => [
        {
          id: newId,
          name: "ISO 9001 Management Review Draft",
          period: "Feb 2025",
          date: new Date().toLocaleString(),
          pages: 12,
          status: "Draft — Pending Review",
  ...
  const [spcSubgroups35, setSpcSubgroups35] = useState<any[]>([
    { subgroup: 1, mean: 3.02, range: 0.1, ooc: false },
    ...
    { subgroup: 19, mean: 3.04, range: 0.1, ooc: false },
    { subgroup: 20, mean: 3.0, range: 0.09, ooc: false },
    { subgroup: 21, mean: 3.08, range: 0.16, ooc: false },
    { subgroup: 22, mean: 3.12, range: 0.18, ooc: false },
    { subgroup: 23, mean: 3.148, range: 0.2, ooc: true, rule: "Rule 5: 2 of 3 beyond +2σ" },
    { subgroup: 24, mean: 3.162, range: 0.2, ooc: true, rule: "Rule 1: Point beyond UCL" },
  ...
  const [instruments36, setInstruments36] = useState([
    ...
    },
    {
      ...
      days: -4,
      status: "Overdue",
      cert: "CAL-2024-VN204-001",
      hold: true,
      custodian: "Ramesh Kumar",
    },
    {
      id: "VN-207",
      name: "Height Gauge 0-600mm",
      location: "QC Lab",
      due: "14 Feb 2025",
      days: 23,
      status: "Due Soon",
      cert: "CAL-2024-207",
      hold: false,
      custodian: "Suresh Nair",
    },
    {
      id: "VN-210",
      name: "Go/No-Go Gauge M12",
      location: "Assembly 2",
      due: "8 Feb 2025",
      days: 17,
      status: "Due Soon",
    ...
    },
    {
      ...
      cert: "CAL-2024-214",
      hold: true,
      custodian: "Deepak Joshi",
    },
    {
      id: "VN-218",
      name: "Bore Gauge 12–18mm",
      location: "CNC Line 1",
      due: "22 Jan 2025",
      days: 0,
      status: "Overdue",
    ...
    },
    {
      ...
      cert: "CAL-2024-221",
      hold: false,
      custodian: "Arun Patel",
    },
    {
      id: "VN-225",
      name: "Precision Balance 0–500g",
      location: "QC Lab",
      due: "1 Mar 2025",
      days: 38,
      status: "Compliant",
  ...
  const handleToggleHold36 = (id: string) => {
    setInstruments36((prev) =>
      prev.map((inst) => (inst.id === id ? { ...inst, hold: !inst.hold } : inst)),
    );
      ...
      prev.map((inst) =>
        inst.id === id
          ? {
              ...
              days: 180,
              hold: false,
              due: "Next recalibrated standard date",
            }
          : inst,
      ),
    );
  ...
  const [complaints37, setComplaints37] = useState([
    ...
    },
    {
      ...
      product: "MS-208",
      defect: "Hole position offset makes assembly brackets stiff to screw",
      qty: 50,
      batch: "B-4809",
      status: "D1–D2 Done",
      "8dStatus": "D1-D2 Pre-populated",
      ncr: "NCR-2024-438",
      date: "24 Jan 2025",
    },
    {
      ...
      customer: "Maruti Ancillaries",
      product: "PC-112",
      defect: "Flange thickness deviation of 0.4mm causes loose casting fit",
      qty: 30,
      batch: "B-4797",
      status: "Draft",
      "8dStatus": "Draft Started",
      ncr: "None",
      date: "21 Jan 2025",
    },
  ]);
  const [selectedCompId37, setSelectedCompId37] = useState("CMP-2024-441");
  const [d5ToD8Answers37, setD5ToD8Answers37] = useState<
    Record<string, { d5: string; d6: string; d7: string; d8: string }>
  >({
    "CMP-2024-441": {
      d5: "Use secondary supplier fixture template plates",
      d6: "Fitted micro-switches to check template alignment",
      d7: "Updated standard QMS program reference file doc to PRG-MS204-V3.2",
      d8: "QA Team + CNC Operations recognized in weekly shift reviews",
    },
  });

  const activeComp37 = complaints37.find((c) => c.id === selectedCompId37) || complaints37[0];

  const handleSave8DAnswers37 = (
    id: string,
    answers: { d5: string; d6: string; d7: string; d8: string },
  ) => {
    setD5ToD8Answers37((prev) => ({ ...prev, [id]: answers }));
    setComplaints37((prev) =>
      prev.map((c) =>
        c.id === id ? { ...c, status: "Complete", "8dStatus": "8D Complete & Signed Off" } : c,
      ),
    );
  ...
  const handleAddInspection31 = () => {
    const isOut = parseFloat(newInsWall31) > 3.2 || parseFloat(newInsSurface31) > 3.2;
  ...
  >({
    ...
    "Jain Traders, Surat": [
      { sender: "dealer", time: "8:53 PM", text: "Please share LR number for yesterday's load." },
      {
        sender: "ai",
        time: "8:55 PM",
        text: "Sure Jain Traders! LR No: TM24-88685 via Surat Fast Lines. Estimated delivery tomorrow.",
        responseTime: "14s",
      },
    ],
  });
  ...
  const [queryLog41, setQueryLog41] = useState([
    ...
    {
      time: "8:55 PM",
      dealer: "Jain Traders, Surat",
      type: "Dispatch LR Number",
      timeTaken: "14s",
      status: "Resolved",
    },
    {
      time: "7:20 PM",
      dealer: "Kumar Enterprises, Ahmedabad",
      type: "Credit Limit Query",
      timeTaken: "9s",
      status: "Resolved",
    },
    {
      time: "6:44 PM",
      dealer: "Mehta Brothers, Rajkot",
      type: "Return Request",
      timeTaken: "—",
  ...
  const [orders42, setOrders42] = useState([
    {
      id: "ORD-2024-1047",
      dealer: "Shah Merchants, Surat",
      channel: "Email",
      items: "PC-112 × 150, MS-204 × 500",
      value: "₹5.14L",
      status: "ERP Created",
      progress: "created",
    },
    {
      id: "ORD-2024-1046",
      dealer: "Parikh Agencies, Ahmedabad",
      channel: "WhatsApp",
      items: "SP-044 × 400",
      value: "₹2.88L",
      status: "ERP Created",
    ...
    {
      id: "ORD-2024-1045",
      dealer: "Trivedi Trading, Rajkot",
      channel: "Portal",
      items: "MS-212 × 200, PC-118 × 100",
      value: "₹3.96L",
      status: "ERP Created",
      progress: "created",
    },
    {
      ...
      items: "MS-204 × 800",
      value: "₹4.64L",
      status: "Credit Hold — Sales Review",
      progress: "validated",
    },
    {
      id: "ORD-2024-1043",
  ...
  const handleSimulateParse42 = () => {
    ...
    setTimeout(() => {
      ...
      toast.dismiss();
      toast.success(
        "Order validated! Standard slab pricing B and credit limit limits passed successfully.",
      );
    }, 1800);
  };
  ...
  const handleApproveOrder42 = (id: string) => {
    setOrders42((prev) =>
      prev.map((o) => (o.id === id ? { ...o, status: "ERP Created", progress: "created" } : o)),
    );
  ...
  const handleRejectOrder42 = (id: string) => {
    setOrders42((prev) =>
      prev.map((o) => (o.id === id ? { ...o, status: "Rejected", progress: "idle" } : o)),
    );
  ...
  const [shipments43, setShipments43] = useState([
    {
      id: "ORD-2024-1036",
      dealer: "Sharma Dist., Vadodara",
      dispatchDate: "21 Jan",
      lr: "TM24-88710",
      transporter: "Vadodara Transport",
      status: "In Transit",
      delay: 0,
    },
    {
    ...
    },
    {
      ...
      dispatchDate: "21 Jan",
      lr: "TM24-88718",
      transporter: "Rajkot Carriers",
      status: "In Transit",
      delay: 0,
    },
    {
      id: "ORD-2024-1033",
      dealer: "Kumar Ent., Ahmedabad",
      dispatchDate: "19 Jan",
      lr: "TM24-88690",
  ...
  const [notificationsSent43, setNotificationsSent43] = useState([
    { time: "Today 8:12 AM", dealer: "Patel Agencies", type: "Scheduled Alert", status: "Read" },
    {
      ...
      dealer: "Shah Merchants",
      type: "Dispatch Track Link",
      status: "Delivered",
    },
    {
      time: "Yesterday 11:20 AM",
      dealer: "Kumar Enterprises",
      type: "Delay Apology Alert",
      status: "Read",
    },
  ]);
  ...
  const handleSendManualUpdate43 = (shipmentId: string) => {
    ...
    setNotificationsSent43((prev) => [
      {
        time: "Just Now",
        dealer: activeShipment43.dealer.split(",")[0],
        type: "Manual Track Log",
        status: "Sent",
      },
      ...prev,
    ]);
  ...
  const handleTriggerDelayAlert43 = (shipmentId: string) => {
    setShipments43((prev) =>
      prev.map((s) => (s.id === shipmentId ? { ...s, status: "Delayed", delay: s.delay + 1 } : s)),
    );
  ...
  const handleAddressStagnation44 = (dealer: string, action: string) => {
    ...
    setSellThroughData44((prev) =>
      prev.map((item) => (item.dealer === dealer ? { ...item, status: "Under Review" } : item)),
    );
  };
  ...
  const [receivables45, setReceivables45] = useState([
    {
      ...
      creditLimit: 3000000,
      creditUtilized: 1850000,
      region: "West",
      ptpCompliance: 88,
      gstNo: "24AAACS1234A1ZA",
    },
    {
      dealer: "Kumar Ent., Ahmedabad",
      inv: "INV-2024-4398",
      ...
      creditLimit: 5000000,
      creditUtilized: 4260000,
      region: "West",
      ptpCompliance: 92,
      gstNo: "24BBBBD5678B1ZB",
    },
    {
      dealer: "Jain Traders, Surat",
      inv: "INV-2024-4389",
      ...
      days: 15,
      stage: "T+15 Sent",
      status: "Escalated to RSM",
      creditLimit: 2000000,
      creditUtilized: 1480000,
      region: "West",
      ptpCompliance: 65,
      gstNo: "24CCCCE9012C1ZC",
    },
    {
      dealer: "Raval Dist., Vadodara",
      inv: "INV-2024-4371",
      amount: 348000,
      due: "29 Dec 2024",
      days: 24,
      stage: "T+15 Sent",
      status: "Committed: 28 Jan",
      creditLimit: 4000000,
      creditUtilized: 2920000,
      region: "West",
      ptpCompliance: 78,
      gstNo: "24DDDDF3456D1ZD",
    },
    {
      dealer: "Modi Sales, Ahmedabad",
      inv: "INV-2024-4344",
      amount: 224000,
      due: "22 Dec 2024",
      days: 31,
      stage: "Credit Hold",
      status: "Sales Head Notified",
      creditLimit: 2500000,
      creditUtilized: 2450000,
      region: "West",
      ptpCompliance: 42,
      gstNo: "24EEEEG7890E1ZE",
    },
    {
      dealer: "Nair Agencies, Chennai",
      inv: "INV-2024-4450",
      amount: 312000,
      due: "10 Jan 2025",
      days: 12,
      ...
      status: "Awaiting Reply",
      creditLimit: 3500000,
      creditUtilized: 1640000,
      region: "South",
      ptpCompliance: 84,
      gstNo: "33FFFFF1234A2ZB",
    },
    {
      dealer: "Mehta & Sons, Mumbai",
      inv: "INV-2024-4462",
      amount: 580000,
      due: "05 Dec 2024",
      days: 48,
      ...
      status: "Sales Head Notified",
      creditLimit: 6000000,
      creditUtilized: 5820000,
      region: "West",
      ptpCompliance: 58,
      gstNo: "27GGGGG5678B2ZC",
    },
    {
      dealer: "Aggarwal Dist., Delhi",
      inv: "INV-2024-4475",
      amount: 245000,
      due: "18 Jan 2025",
      days: 4,
      ...
      status: "Awaiting Reply",
      creditLimit: 4000000,
      creditUtilized: 1250000,
      region: "North",
      ptpCompliance: 90,
      gstNo: "07HHHHH9012C2ZD",
    },
    {
      dealer: "Kolkata Sales, Howrah",
      inv: "INV-2024-4488",
      amount: 185000,
      due: "20 Jan 2025",
      days: 2,
      ...
      status: "Awaiting Reply",
      creditLimit: 2500000,
      creditUtilized: 1020000,
      region: "East",
      ptpCompliance: 72,
      gstNo: "19IIIII3456D2ZE",
    },
  ]);
  const [selectedRecId45, setSelectedRecId45] = useState("INV-2024-4398");

  const activeReceivable45 =
    receivables45.find((r) => r.inv === selectedRecId45) || receivables45[0];

  const handleSendReminder45 = (invNum: string) => {
    toast.success(`WhatsApp reminder re-dispatched for invoice ${invNum} successfully.`);
    setReceivables45((prev) =>
      prev.map((r) =>
        r.inv === invNum ? { ...r, status: "Urgent Reminder Sent", stage: "Nudged Manually" } : r,
      ),
    );
  };
  ...
  const handleRegisterCommitment45 = (invNum: string, date: string) => {
    setReceivables45((prev) =>
      prev.map((r) => (r.inv === invNum ? { ...r, status: `Committed: ${date}` } : r)),
    );
  ...
  const handleApproveCredit46 = (name: string, limit: number) => {
    toast.success(
      `Credit limit approved at ₹${limit}L for ${name}! Onboarding routed to digital agreement e-sign.`,
    );
  ...
  const [m62LineGridData, setM62LineGridData] = useState([
    {
      ...
      target: 1800,
      variance: -20.0,
      note: "Tooling issues — coolant low",
    },
    {
      id: "line2",
      name: "Assembly Line 2",
    ...
    },
    {
      ...
      target: 1520,
      variance: -35.5,
      note: "Changeover in progress — ETA 25 min",
    },
    {
      id: "line4",
      name: "Welding Line 4",
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setM62LineGridData((prev) =>
        prev.map((line) => {
          if (
            line.status === "Running" ||
            line.status === "Ahead" ||
            line.status === "On Track" ||
            line.status === "Below Target"
          ) {
            ...
            return {
              ...
              variance: Number(
                (((line.actual + increment - line.target) / line.target) * 100).toFixed(1),
              ),
            };
          }
          return line;
  ...
  const [m62HandoverStatus, setM62HandoverStatus] = useState<"unacknowledged" | "acknowledged">(
    "unacknowledged",
  );
  const [m62OeeComponents, setM62OeeComponents] = useState<
    Record<
      string,
      {
        avail: number;
        ...
        qualTarget: number;
        notes: string[];
        ticket: { id: string; desc: string; status: string; openTime: string; eta: string } | null;
      }
    >
  >({
    "CNC Line 1": {
      ...
      notes: [
        ...
        "Performance loss: Coolant pressure low — ticket #MT-441 open",
      ],
      ticket: {
        id: "MT-441",
        desc: "Coolant system — Assigned to Maintenance Team",
        status: "In Progress",
        openTime: "07:52 AM",
        eta: "11:00 AM",
      },
    ...
    "Assembly Line 2": {
      ...
      qualTarget: 99,
      notes: [
        "Highly synchronized conveyor pace",
        "Zero active downtime events during current shift",
      ],
      ticket: null,
    },
    "Stamping Line 3": {
      ...
      perfTarget: 95,
      qualTarget: 99,
      notes: ["Planned changeover completed at 08:30 AM"],
      ticket: null,
    },
    "Welding Line 4": {
      avail: 89,
      ...
      perfTarget: 95,
      qualTarget: 99,
      notes: ["Slight electrode wear slowing weld rate by 3%"],
      ticket: null,
    },
    "Painting Line 5": {
      avail: 92,
      ...
      perfTarget: 95,
      qualTarget: 99,
      notes: ["Optimal dryer temperature maintained"],
      ticket: null,
    },
    "Dispatch Packing": {
      avail: 90,
  ...
  const handleSendAlertToProdHead = () => {
    toast.info(
      "Production status escalation sent to Production Head (Mahesh Kapoor) via SMS and App alert.",
    );
  };
  ...
  const handleAcknowledgeHandover = () => {
    ...
    toast.success(
      "Shift handover report accepted and acknowledged! Morning shift performance archived.",
    );
  };
  ...
  const handleRaisePO63 = (itemId: number, code: string) => {
    setM63Items((prev) =>
      prev.map((item) =>
        item.id === itemId ? { ...item, actionTaken: true, status: "Normal" } : item,
      ),
    );
    toast.success(
      `Purchase Order request raised in ERP for ${code}! Draft PO routed to Procurement Desk.`,
    );
  };
  ...
  const handleRaiseAllUrgent63 = () => {
    setM63Items((prev) =>
      prev.map((item) =>
        item.status === "Critical" || item.status === "Stock Out"
          ? { ...item, actionTaken: true, status: "Normal" }
          : item,
      ),
    );
    toast.success(
      "Emergency POs triggered for all 3 critical & stock out items! High-priority notifications dispatched to vendors.",
    );
  };
  ...
  const [m64Opportunities, setM64Opportunities] = useState([
    ...
    {
      id: 4,
      name: "FMCG packaging parts",
      customer: "Amul Packaging",
      value: 72,
      stage: "Demo done",
      prob: 80,
    },
    {
      id: 5,
      name: "New casting contract",
      customer: "Godrej Precision",
      value: 65,
      stage: "RFQ stage",
      prob: 50,
    },
  ...
  const [m65EbitdaWaterfall] = useState([
    { name: "Revenue", value: 380, color: "var(--color-primary)" },
    { name: "Raw Materials", value: -233, color: "var(--color-destructive)" },
    { name: "Direct Labour", value: -31, color: "var(--color-destructive)" },
    { name: "Overheads", value: -40, color: "var(--color-destructive)" },
    { name: "Utilities", value: -19, color: "var(--color-destructive)" },
    { name: "Maintenance", value: -11, color: "var(--color-destructive)" },
    { name: "EBITDA MTD", value: 46, color: "var(--color-chart-2)" },
  ]);

  const handleReviewRate65 = (id: number, material: string) => {
    setM65MaterialVariances((prev) =>
      prev.map((v) => (v.id === id ? { ...v, reviewStarted: true } : v)),
    );
    toast.success(
      `Purchase contract rate negotiation case opened for ${material}! Sent RFQ revision request to Mehta Steel Works.`,
    );
  };

  const handleSendToCFO65 = () => {
    toast.success(
      "Adverse cost variance summary and EBITDA shortfall analysis dispatched to CFO's (Ananya Patel) WhatsApp successfully!",
    );
  };
  ...
  const [m66Training] = useState([
    {
      type: "Safety Induction (Annual)",
      due: 4,
      overdue: 4,
      earliest: "15 Jan 2025",
      status: "Critical",
    },
    {
      type: "CNC Machine Safety Cert",
      due: 2,
      overdue: 1,
      earliest: "28 Jan 2025",
      status: "Urgent",
    },
    {
      type: "Welding Safety & PPE",
      due: 3,
      overdue: 3,
      earliest: "10 Jan 2025",
      status: "Overdue",
    },
    {
      type: "Quality SOP Requalification",
      due: 2,
      overdue: 0,
      earliest: "31 Jan 2025",
  ...
  const handleFlagOperator66 = (id: number, name: string) => {
    ...
    toast.success(
      `Operator ${name} flagged for skill gap review. HR auto-alerted for scheduling training requalification.`,
    );
  };

  const handleScheduleTraining66 = (trainingType: string) => {
    toast.success(
      `Refresher training batches scheduled for: "${trainingType}" immediately! Participants notified.`,
    );
  };
  ...
  const [m71CallHistory, setM71CallHistory] = useState([
    ...
    {
      id: 4,
      caller: "+91 98795 XXXXX",
      account: "Reliance Consumer",
      lang: "English",
      query: "Order Status",
      duration: "1:15",
      resolution: "Resolved",
    ...
    {
      id: 5,
      caller: "+91 90163 XXXXX",
      account: "Shah Traders, Surat",
      lang: "Gujarati",
      query: "Partial Delivery",
      duration: "2:44",
      resolution: "Resolved",
      time: "11:02 AM",
    },
    {
      id: 6,
      caller: "+91 98330 XXXXX",
      account: "L&T Construction",
      lang: "English",
      query: "Pricing Query",
      duration: "1:58",
      resolution: "Resolved",
    ...
    {
      id: 7,
      caller: "+91 97126 XXXXX",
      account: "Mehta Brothers, Vadodara",
      lang: "Gujarati",
      query: "Order Status",
      duration: "1:33",
      resolution: "Resolved",
    ...
    {
      id: 8,
      caller: "+91 99009 XXXXX",
      account: "Bajaj Auto Components",
      lang: "Hindi",
  ...
  const handleSimulateCall71 = () => {
    ...
    const newCall = {
      ...
      transcript: [
        "Connecting call...",
        "AI Assistant: Namaste, aap Fortiv ManufactureSmart ke AI assistant se baat kar rahe hain. Kripya apna company name ya registered mobile number batayein.",
      ],
      erpPushed: false,
    };
    ...
    activeCallIntervalRef.current = setInterval(() => {
      ...
      if (counter === 5) {
        setM71ActiveCall((prev) =>
          prev
            ? {
                ...prev,
                transcript: [
                  ...prev.transcript,
                  "Caller: Mera naam Rajesh Kapoor hai, Kapoor Industries se. Mera order #4821 ka kya status hai?",
                ],
              }
            : null,
        );
        ...
        setM71ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "AI Assistant: Dhanyawad Rajesh ji. Kapoor Industries ka account verified. Main order details search kar raha hoon...",
                ],
              }
            : null,
        );
        ...
        setM71ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "Caller: Bohot ache. expected delivery kab tak hai?",
                ],
              }
            : null,
        );
        ...
        setM71ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "AI Assistant: expected delivery aaj shaam ya kal subha hai. Kya aapko WhatsApp par summary aur tracking link chahiye?",
                ],
              }
            : null,
        );
        ...
        setM71ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "AI Assistant: WhatsApp summary sent. Thank you for calling Fortiv. Have a nice day!",
                ],
              }
            : null,
        );
        ...
        toast.success(
          "Call ended successfully. Summary notification dispatched to customer via WhatsApp.",
        );
      }
    }, 4000);
  };
  ...
  const [m72ComplaintHistory, setM72ComplaintHistory] = useState([
    ...
    {
      id: 2,
      complaintId: "CMP-2024-442",
      account: "Tata AutoComp",
      defect: "Dimensional Variation",
      severity: "Critical",
      qty: "1,200 units",
      lang: "English",
      status: "Escalated to QA Head",
    },
    {
      id: 3,
      complaintId: "CMP-2024-443",
      account: "Bajaj Auto Components",
      defect: "Packaging Damage",
      severity: "Minor",
      qty: "30 units",
      lang: "Hindi",
      status: "Routed to Dispatch",
    },
    {
      id: 4,
      complaintId: "CMP-2024-444",
      account: "Shah Traders, Surat",
      defect: "Wrong Item",
      severity: "Major",
      qty: "400 units",
      lang: "Gujarati",
      status: "Routed to Sales Admin",
    },
    {
      id: 5,
      complaintId: "CMP-2024-445",
      account: "Maruti Ancillaries",
      defect: "Late Delivery",
      severity: "Minor",
      qty: "—",
      lang: "Hindi",
      status: "Routed to Dispatch",
  ...
  const handleSimulateComplaintCall72 = () => {
    ...
    const newCall = {
      ...
      transcript: [
        "Connecting call...",
        "AI Assistant: Namaste, Fortiv ManufactureSmart Quality Desk. Main aapki kya sahayata kar sakta hoon?",
      ],
      fields: {
    ...
    activeComplaintIntervalRef.current = setInterval(() => {
      ...
      if (counter === 5) {
        setM72ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "Caller: Mujhe bohot badi problem aayi hai. Aaj jo batch deliver hua hai MS-204 components ka, usme rust marks hain! Poore pieces khraab lag rahe hain.",
                ],
              }
            : null,
        );
        ...
        setM72ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "Caller: Ha, approx 200 units affected hain out of 1,000.",
                ],
              }
            : null,
        );
        ...
        setM72ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "AI Assistant: Samjha, 200 units surface rust. Order reference number kya hai? Aur product batch number?",
                  "Caller: Invoice number hai INV-4421, order number SO-2024-4821.",
                ],
              }
            : null,
        );
        ...
        setM72ActiveCall((prev) =>
          prev
            ? {
                ...
                transcript: [
                  ...prev.transcript,
                  "Caller: Theek hai, main update ka wait karta hoon. defect ki photo WhatsApp bhej du?",
                  "AI Assistant: Ji haan Rajesh ji, is registered chat par ek photo bhej dijiye. Thank you for cooperation.",
                ],
              }
            : null,
        );
        ...
        toast.success(
          "M8 Complaint ticket CMP-2024-450 registered! Routed to QA Team Sunita Patel (SLA: 8 hrs).",
        );
      }
    }, 4500);
  };
  ...
  const [m73OverdueAccounts, setM73OverdueAccounts] = useState([
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "નમસ્તે પટેલ એજન્સીસ, હું ફોર્ટીવ ઓટોમેટેડ વોઇસ આસિસ્ટન્ટ બોલું છું. આપનું ઇન્વોઇસ INV-4421 નું ₹2.84 લાખનું ચુકવણું 8 દિવસથી બાકી છે. ક્યારે કરી આપશો?",
        },
        {
          speaker: "Customer",
          text: "હા, જય શ્રી કૃષ્ણ. એ પેમેન્ટ મેં ચેકથી કાઢી દીધું છે, ૩૧ જાન્યુઆરી સુધીમાં તમારા ખાતામાં જમા થઇ જશે.",
        },
        {
          speaker: "Agent",
          text: "ધન્યવાદ. હું ૩૧ જાન્યુઆરી ૨૦૨૫ ની તારીખ નોંધી લઉં છું. પ્રણામ.",
        },
      ],
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "नमस्ते शर्मा डिस्ट्रीब्यूटर्स। आपका बिल INV-4398 ₹1.92 लाख के लिए 13 दिनों से लंबित है। क्या आप भुगतान की स्थिति बता सकते हैं?",
        },
        {
          speaker: "Customer",
          text: "भैया, हमारा माल कुछ रास्ते में अटका था, कल ही मिला है। हम तीन-चार दिन में ऑनलाइन ट्रांसफर कर देंगे।",
        },
    ...
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "नमस्ते मेहता एजेंसीज। आपका बिल INV-4412 ₹4.50 लाख के लिए 11 दिनों से लंबित है।",
        },
        {
          speaker: "Customer",
          text: "जी, पेमेंट कल ही अकाउंट्स विभाग ने अप्रूव किया है, 30 जनवरी को आपके खाते में एनईएफटी हो जाएगा।",
        },
    ...
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "નમસ્તે ગુજરાત ટ્રેડર્સ, આપનું ઇન્વોઇસ INV-4389 ₹3.18 લાખનું બાકી છે.",
        },
        {
          speaker: "Customer",
          text: "અરે યાર, કેટલી વાર ફોન કરશો? અમારા કેટલાય માલના નંગ ખરાબ નીકળ્યા છે, સેલ્સ ટીમને કમ્પ્લેઇન કરી છે પણ કોઈ સાંભળતું નથી! પહેલા એ સોલ્વ કરો પછી પેમેન્ટ થશે!",
        },
        {
          speaker: "Agent",
          text: "દિલગીર છીએ. હું આ પેમેન્ટ રોકીને તમારી ક્વોલિટી કમ્પ્લેઇન સેલ્સ હેડને મોકલી આપું છું.",
        },
      ],
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "Hello Kapoor Industries, this is Fortiv Collections. Invoice INV-4367 for ₹78,000 is 18 days overdue.",
        },
        {
          speaker: "Customer",
          text: "Ah yes, we had some accounting system issues. We are processing it today. Expect it by 29th Jan.",
        },
    ...
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "નમસ્તે જોશી એન્ડ સન્સ, આપનું ઇન્વોઇસ INV-4401 બાકી છે. ક્યારે પેમેન્ટ કરશો?",
        },
        {
          speaker: "Customer",
          text: "આવતા મંગળવારે અમારા એકાઉન્ટન્ટ આવશે એટલે એનઈએફટી કરાવી દઈશ.",
        },
    ...
    },
    {
      ...
      transcript: [
        ...
        {
          speaker: "Customer",
          text: "ફોન મૂકો ભાઈ, અત્યારે બજાર મંદીમાં છે. ટાઈમ મળશે ત્યારે આપી દઈશું, વારંવાર ફોન ના કરો.",
        },
        {
          speaker: "Agent",
          text: "ચૂકવણું મોડું હોવાથી ફાઇલ સીએફઓ ડેસ્ક પર મોકલવામાં આવી રહી છે.",
        },
      ],
    },
    {
      ...
      transcript: [
        {
          speaker: "Agent",
          text: "नमस्ते आर.के. इंजीनियरिंग। आपका बिल INV-4441 का पेमेंट अभी पेंडिंग है।",
        },
        {
          speaker: "Customer",
          text: "हाँ, हम कल ही चेक भेजने वाले हैं। कोरियर रिसीप्ट व्हाट्सऐप पर भेज देंगे।",
        },
    ...
    },
    {
      ...
      transcript: [
        ...
        {
          speaker: "Customer",
          text: "હા, મનીષ ત્રિવેદી બોલું છું. ૨ જી ફેબ્રુઆરીએ અમારો એક મોટો પેમેન્ટ આવવાનો છે, એમાંથી ડાયરેક્ટ ટ્રાન્સફર કરી દઈશ.",
        },
    ...
    },
    {
      ...
      transcript: [
        ...
        {
          speaker: "Customer",
          text: "Our account manager is out of station today. He will process it tomorrow morning.",
        },
  ...
  const activeAccount73 =
    m73OverdueAccounts.find((a) => a.id === selectedAccountId73) || m73OverdueAccounts[0];

  const handleToggleWrongNumber73 = (id: number) => {
    setM73OverdueAccounts((prev) =>
      prev.map((acc) => {
        if (acc.id === id) {
          const nextVal = !acc.isWrongNumber;
          toast.info(
            nextVal
              ? `Flagged contact for ${acc.account} as Wrong Number`
              : `Restored contact for ${acc.account}`,
          );
          return {
            ...acc,
  ...
  const handleSecureCommitment73 = (id: number, promisedDate: string) => {
    setM73OverdueAccounts((prev) =>
      prev.map((acc) =>
        acc.id === id ? { ...acc, commitment: promisedDate, status: "Commitment" } : acc,
      ),
    );
    toast.success(
      `PTP (Promise to pay) updated to ${promisedDate} for this invoice! Reminders paused.`,
    );
  };
  ...
  const handleEscalate73 = (id: number, name: string) => {
    setM73OverdueAccounts((prev) =>
      prev.map((acc) =>
        acc.id === id
          ? { ...acc, status: "Escalated to Credit Manager", commitment: "Escalated" }
          : acc,
      ),
    );
    toast.warning(
      `Overdue account for ${name} escalated to credit and collections desk. Direct intervention triggered.`,
    );
  };
  ...
  const handleRunReminderCampaign73 = () => {
    ...
    toast.loading(
      "Triggering automated outbound collection voice campaign via telephony trunk line...",
    );
    ...
    setTimeout(() => {
      ...
      toast.dismiss();
      toast.success(
        "Outbound reminder voice campaign executed successfully! Secured 2 new payment commitments (₹2.8L).",
      );
    }, 2800);
  };
  ...
  const [m74Dealers, setM74Dealers] = useState([
    {
      ...
      trend: "up",
      date: "22 Jan",
      feedback: "Zero complaints, very happy.",
    },
    {
      id: 2,
      name: "Mehta Brothers",
      ...
      trend: "stable",
      date: "24 Jan",
      feedback: "Standard delivery could be slightly faster.",
    },
    {
      id: 3,
      ...
      trend: "down",
      date: "21 Jan",
      feedback: "Packaging quality is poor, rust on corners.",
      alerted: false,
    },
    {
      id: 4,
      ...
      trend: "up",
      date: "25 Jan",
      feedback: "Excellent support and quick dispatches.",
    },
    {
      id: 5,
      name: "Joshi & Sons",
      ...
      trend: "stable",
      date: "18 Jan",
      feedback: "Need invoices immediately on dispatch.",
    },
    {
      id: 6,
      name: "Trivedi Traders",
      city: "Surat",
      score: 8.2,
      category: "Promoter",
      trend: "stable",
      date: "20 Jan",
      feedback: "Consistent product quality.",
    },
    {
      id: 7,
      ...
      trend: "down",
      date: "15 Jan",
      feedback: "Dimensional variations in stamped panels.",
      alerted: false,
    },
    {
      id: 8,
      ...
      trend: "up",
      date: "22 Jan",
      feedback: "Solid account manager coordination.",
    },
    {
      id: 9,
      name: "Nair Industries",
      city: "Ahmedabad",
      score: 7.5,
      category: "Passive",
      trend: "stable",
      date: "23 Jan",
      feedback: "Need automatic tracking links.",
    },
  ]);
  ...
  const handleEscalateDetractor74 = (id: number, name: string) => {
    ...
    toast.success(
      `NPS detractor alert generated! Customer relationship ticket pushed to Regional Sales Manager Vadodara/Ahmedabad.`,
    );
  };
  ...
  const handleTriggerSurveyCampaign74 = () => {
    ...
    setTimeout(() => {
      ...
      toast.dismiss();
      toast.success(
        "Survey feedback calling completed for active dealer base! Collected 3 new NPS records.",
      );
    }, 2000);
  };
  ...
  const [m81Complaints, setM81Complaints] = useState([
    ...
    },
    {
      ...
      icon: "📧",
      customer: "Tata AutoComp",
      desc: "Short delivery — 200 units missing from SO-4822",
      status: "Routed to Dispatch",
      severity: "Major",
    },
    {
      ...
      icon: "📞",
      customer: "Maruti Ancillaries",
      desc: "Wrong invoice number — GST mismatch",
    ...
    },
    {
      ...
      icon: "🌐",
      customer: "Bajaj Auto",
      desc: "Dimensional issue — shaft diameter out of spec",
      status: "CAPA Raised",
      severity: "Critical",
    },
    {
      ...
      icon: "📱",
      customer: "Reliance Consumer",
      desc: "Packaging torn — 3 cartons damaged in transit",
      status: "Resolved",
      severity: "Minor",
    },
    {
      ...
      icon: "💬",
      customer: "L&T Construction",
      desc: "Late delivery — 4 days overdue",
      status: "Escalated",
      severity: "Major",
    },
    {
      ...
      icon: "📧",
      customer: "Godrej Precision",
      desc: "Material test certificate missing from delivery",
      status: "Acknowledged",
      severity: "Minor",
    },
  ]);
  ...
  const handleCreateManualTicket81 = () => {
    const newTicket = {
      ...
      channel: "Manual",
      icon: "✏️",
      customer: "Walk-In Complaint",
      desc: "Manually logged quality concern — awaiting details",
  ...
  const [m82ClassificationLog, setM82ClassificationLog] = useState([
    {
      ...
      complaintId: "CMP-2024-441",
      customer: "Kapoor Industries",
      classification: "Quality — Surface Finish",
      severity: "Major",
      confidence: 94,
      routedTo: "QA Team — Sunita Patel",
      time: "6 sec",
      overridden: false,
    },
    {
      id: 2,
      complaintId: "CMP-2024-440",
      customer: "Tata AutoComp",
      classification: "Delivery — Short Shipment",
      severity: "Major",
      confidence: 98,
      routedTo: "Dispatch Manager — Kavita Sharma",
      time: "4 sec",
      overridden: false,
    },
    {
      id: 3,
      complaintId: "CMP-2024-439",
      customer: "Maruti Ancillaries",
      classification: "Documentation — GST Error",
      severity: "Minor",
      confidence: 91,
      routedTo: "Finance — Anita Kapoor",
      time: "7 sec",
      overridden: false,
    },
    {
      id: 4,
      complaintId: "CMP-2024-438",
      customer: "Bajaj Auto",
      classification: "Quality — Dimensional",
      severity: "Critical",
      confidence: 89,
      routedTo: "QA Team — Sunita Patel",
      time: "8 sec",
    ...
    {
      id: 5,
      complaintId: "CMP-2024-437",
      customer: "Reliance Consumer",
      classification: "Packaging — Damaged",
      severity: "Minor",
      confidence: 96,
      routedTo: "Dispatch / Stores — Kavita Sharma",
      time: "5 sec",
      overridden: false,
    },
    {
      id: 6,
      complaintId: "CMP-2024-436",
      customer: "L&T Construction",
      classification: "Delivery — Late",
      severity: "Major",
      confidence: 87,
      routedTo: "Production + Dispatch — Deepak Trivedi",
      time: "9 sec",
      overridden: false,
    },
    {
      id: 7,
      complaintId: "CMP-2024-435",
      customer: "Godrej Precision",
      classification: "Documentation — Missing Certificate",
      severity: "Minor",
      confidence: 93,
      routedTo: "QA Team — Sunita Patel",
      time: "6 sec",
  ...
  const handleClassifyComplaint82 = () => {
    ...
    toast.loading(
      "AI NLP engine reading complaint text and classifying against defect taxonomy...",
    );
    setTimeout(() => {
      ...
      const newEntry = {
        id: Date.now(),
        complaintId: `CMP-2024-${450 + Math.floor(Math.random() * 10)}`,
      ...
      toast.success(
        "AI classification complete in 6 seconds! Complaint routed to QA Team, SLA clock started.",
      );
    }, 2500);
  };
  const handleOverrideClassification82 = (id: number) => {
    setM82ClassificationLog((prev) =>
      prev.map((c) =>
        c.id === id
          ? {
              ...c,
              overridden: true,
              classification: "Quality — Dimensional (Override)",
              confidence: 100,
            }
          : c,
      ),
  ...
  const [m84Capas, setM84Capas] = useState([
    ...
    {
      id: 3,
      capaId: "CAPA-2024-430",
      complaintId: "CMP-2024-430",
      customer: "Tata AutoComp",
      defect: "Material Property",
      severity: "Major",
    ...
    {
      id: 5,
      capaId: "CAPA-2024-412",
      complaintId: "CMP-2024-412",
      customer: "L&T Construction",
      defect: "Late Delivery",
      severity: "Major",
  ...
  const handleAdvanceCapa84 = (id: number) => {
    ...
    toast.success(
      "CAPA stage advanced! Updated notifications dispatched to QA team and stakeholders.",
    );
  };
  const handleEscalateCapa84 = (id: number, capaId: string) => {
    toast.warning(
      `CAPA ${capaId} escalated to QA Head + Production Head. WhatsApp alert dispatched with full CAPA summary.`,
    );
  };
  const handleNotifyMD84 = () => {
    toast.success(
      "Systemic quality risk alert sent to MD Vikram Joshi via WhatsApp + Email. Review meeting auto-scheduled.",
    );
  };
  ...
  const [m85Timeline] = useState([
    {
      ...
      type: "intake",
      status: "WhatsApp",
      detail: "Surface defect reported on 40 pieces of MS-204",
    },
    {
      id: 2,
      time: "22 Jan 14:42",
      ...
      detail: "Reference CMP-2024-441 shared, QA Team assigned",
    },
    {
      id: 3,
      time: "22 Jan 15:10",
      ...
      type: "update",
      status: "Delivered + Read",
      detail: "QA Team began batch B-4821 analysis",
    },
    {
      id: 4,
      time: "23 Jan 09:15",
      ...
      type: "rootcause",
      status: "Delivered + Read",
      detail: "Zinc coating insufficiency — supplier lot RM-CRCA-1.2",
    },
    {
      id: 5,
      time: "23 Jan 10:30",
      event: "Replacement Dispatched",
      type: "action",
      status: "Delivered + Read",
      detail: "Batch B-4831 dispatched — LR TM24-88755",
    },
    {
      id: 6,
      time: "24 Jan 14:20",
      ...
      type: "resolution",
      status: "Pending",
      detail: "Credit note ₹44,000 + replacement 40 units",
    },
    {
      id: 7,
      time: "26 Jan",
      ...
      type: "nps",
      status: "Scheduled",
      detail: "Post-resolution CSAT/NPS call scheduled",
    },
  ]);
  const [m85NpsScores, setM85NpsScores] = useState([
    ...
    },
    {
      ...
      score: 4,
      category: "Detractor",
      followUp: "Flagged to Sales Manager",
      flagged: false,
    },
    {
      id: 4,
  ...
  const handleSendUpdate85 = () => {
    ...
    setTimeout(() => {
      ...
      toast.dismiss();
      toast.success(
        "Resolution update sent to Kapoor Industries! WhatsApp delivered + read confirmed.",
      );
    }, 2000);
  };
  const handleFlagDetractor85 = (id: number, customer: string) => {
    setM85NpsScores((prev) =>
      prev.map((n) => (n.id === id ? { ...n, flagged: true, followUp: "🔴 Alerted RSM" } : n)),
    );
    toast.warning(
      `Detractor alert for ${customer} sent to Regional Sales Manager! Urgent follow-up ticket created.`,
    );
  };
  ...
  const handleGenerateReport86 = () => {
    ...
    setTimeout(() => {
      ...
      toast.dismiss();
      toast.success(
        "January 2025 Complaint Report generated! PDF dispatched to MD Vikram Joshi, QA Head Sunita Patel via WhatsApp + Email.",
      );
    }, 2500);
  };

  return m.id === "og-regulatory" ? (
    <div className="max-w-[1480px] mx-auto space-y-5">
      ...
      <div className="mt-8 pt-4 border-t border-border/20">
        <Link
          ...
          className="group inline-flex items-center gap-1.5 text-[12.5px] text-muted-foreground hover:text-foreground transition-colors font-semibold"
        >
          <ChevronLeft className="h-3.5 w-3.5 transition-transform duration-300 group-hover:-translate-x-1" /> Back to {m.short}
        </Link>
      </div>
    </div>
  ) : m.id === "og-land-lease" ? (
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      Sync Health: ✓ Healthy & Online
                    </div>
                    <div className="text-[12px] text-muted-foreground font-mono">
                      Last sync: {syncTimeCounter} seconds ago • Ingested: 142 orders • 7 materials
                      below reorder
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Vatva Ingestion Protocol Log
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Real-time synced databases and transaction nodes
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 flex-1 overflow-y-auto max-h-[360px] pr-1.5 font-mono text-[11.5px] leading-relaxed">
                    {syncedRecords.map((log, idx) => (
                      <div
                        key={idx}
                        className="p-3 rounded-lg border bg-muted/40 text-foreground flex items-start gap-2.5"
                      >
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Pending validation and sync corrections
                    </p>
                  </div>
                    ...
                    {anomalies11.map((a) => (
                      ...
                      >
                        <div className="space-y-1.5">
                          ...
                          <div className="text-[12.5px] font-semibold text-foreground leading-snug">
                            {a.title}
                          </div>
                        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    ...
                    {
                      name: "ERPNext Shop Floor MES",
                      status: "Connected",
                      sync: "Real-time socket",
                      latency: "0.2s",
                      ok: true,
                    },
                    {
                      name: "Inventory Database Tunnel",
                      status: "Connected",
                      sync: "15m intervals",
                      latency: "1.2s",
                      ok: true,
                    ...
                    <div
                      key={idx}
                      className="p-4 rounded-xl border bg-card flex items-start justify-between gap-3 shadow-sm"
                    >
                      <div className="space-y-1">
                        ...
                        <div className="text-[11.5px] text-[#1D9E75] font-semibold font-mono mt-2">
                          Latency: {sys.latency}
                        </div>
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Interactive 5-Day Gantt Matrix View
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      6 lines × 5 days shifts layout
                    </p>
                  </div>
                  ...
                  <div className="border rounded-xl p-4 bg-muted/20 space-y-3.5 text-[12.5px] overflow-x-auto min-w-[640px]">
                    ...
                    <div className="grid grid-cols-6 items-center py-1">
                      ...
                      <div
                        className={`col-span-1 ml-1 px-2 py-2 rounded-lg text-center font-mono text-[11px] font-bold transition-all ${
                          conflictResolved
                      ...
                      <div className="col-span-1 text-center text-muted-foreground italic text-[11px] font-mono">
                        Idle
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-6 items-center py-1">
                      ...
                      {conflictResolved ? (
                        ...
                        <div className="col-span-2 text-center text-muted-foreground italic text-[11px] font-mono">
                          Available Space
                        </div>
                      )}
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-3.5 rounded-xl border bg-red-500/5 border-red-500/20 text-[12px] space-y-2">
                      ...
                      <p className="text-muted-foreground leading-snug">
                        Job **JC-4822 (Tata AutoComp)** and **JC-4827 (Ashok Leyland)** overlap
                        Friday morning shift on Line 1. Overload forecast: **118%**.
                      </p>
                    </div>
                    ...
                    {!conflictResolved ? (
                      <div className="space-y-3.5">
                        <div className="text-[12.5px] space-y-1">
                          ...
                          <p className="text-muted-foreground leading-snug">
                            → Move **JC-4827** (Ashok Leyland MS-212) to **Line 4 (Welding Rig)** on
                            **Thursday PM shift**.
                          </p>
                          <p className="text-[#1D9E75] font-semibold text-[11.5px] mt-1">
                            • Materials available ✓ • Welders certified ✓
                          </p>
                        </div>
                      ...
                      <div className="p-3.5 rounded-xl border border-emerald-500/20 bg-emerald-500/5 text-emerald-600 text-[12.5px] space-y-1.5">
                        ...
                        <p className="text-muted-foreground text-[11.5px] leading-snug">
                          Ashok Leyland order shifted to Line 4. CNC Line 1 load reduced to 82%,
                          completely eliminating late delivery risk to Tata Systems.
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div className="rounded-2xl bg-card border p-5">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-[14.5px] font-bold tracking-tight">
                    Active Schedule Job Cards
                  </h4>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => toast.success("Exporting schedule to SAP ERP...")}
                      className="h-8 px-3 rounded-lg border text-[12px] font-medium hover:bg-muted"
                    >
                      Push to ERP
                    </button>
                    <button
                      onClick={() => toast.success("Downloading schedule PDF...")}
                      className="h-8 px-3 rounded-lg bg-primary text-primary-foreground text-[12px] font-medium hover:opacity-90"
                    >
                      Export PDF
                    </button>
                  </div>
                  ...
                  <table className="w-full text-left border-collapse text-[12.5px]">
                    ...
                    <tbody>
                      {jobsList12.map((j) => (
                        ...
                        >
                          <td className="p-2.5 font-mono font-semibold text-[11.5px] text-[#2E86AB]">
                            {j.id}
                          </td>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-red-500/20">
                  ...
                  <div className="text-[20px] font-bold text-[#D85A30] mt-1">
                    {overtimeApplied ? "1 Center" : "2 Centers"}
                  </div>
                </div>
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  ...
                  <div className="text-[20px] font-bold text-[#1D9E75] mt-1">
                    {overtimeApplied ? "5 Centers" : "4 Centers"}
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  <div className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Click any row to inspect bottleneck detail projections
                    </p>
                  </div>
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  ...
                  {(() => {
                    const center =
                      centersData.find((c) => c.name === selectedCenter) || centersData[0];
                    return (
                      <div className="space-y-4">
                          ...
                          {center.ordersAtRisk.length > 0 && (
                            <div className="flex justify-between">
                              ...
                              <span className="font-mono text-red-500 font-bold">
                                {center.ordersAtRisk.join(", ")}
                              </span>
                            </div>
                          )}
                          <div className="flex justify-between">
                            <span className="text-muted-foreground">
                              Forward Load 2-Wk Forecast:
                            </span>
                        ...
                        {center.name === "CNC Line 1" ? (
                          <div className="space-y-3 pt-3 border-t">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="p-3 rounded-lg border bg-accent/30 text-[11.5px] space-y-2">
                                <div>
                                  <strong>Option 1: Overtime Thursday–Friday (+4 hrs)</strong>
                                </div>
                                <p className="text-muted-foreground leading-snug">
                                  Estimates overtime payout at ₹12,400. Increases week capacity by
                                  20 hrs.
                                </p>
                                <button
                              ...
                              <div className="p-3 rounded-lg border bg-accent/30 text-[11.5px] space-y-2">
                                <div>
                                  <strong>Option 2: Reschedule & Split Order</strong>
                                </div>
                                <p className="text-muted-foreground leading-snug">
                                  Split JC-4819 (Kapoor Industries) — move 400 volume units to
                                  backup Line 4.
                                </p>
                                <button
                          ...
                          <div className="p-4 rounded-xl border bg-emerald-500/5 border-emerald-500/20 text-emerald-600 text-[12.5px] font-medium flex items-center gap-2">
                            <CheckCircle className="h-4 w-4" /> Work center load is within safe
                            operating margins. No bottleneck alerts.
                          </div>
                        )}
                      </div>
                    );
              ...
              <div className="rounded-2xl border bg-card text-foreground p-5 space-y-3 font-mono text-[12px] shadow-sm">
                <div className="text-primary font-bold uppercase tracking-wider">
                  🗓 Forward capacity warning matrix
                </div>
          ...
          {s.id === "1-4" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                />
                <KpiCard
                  label="Biometric Present"
                  value={`${headcountPresent} Present`}
                  delta=" eSSL active"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Shortfall Gap"
                  value={`${headcountGap} Absent`}
                  delta="3 Critical roles"
                  tone={headcountGap > 11 ? "danger" : "warning"}
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Suggested Substitutes"
                  value="6 Backfills Ready"
                  delta="Rosters match"
                  tone="success"
                  sparkline={<SparkLine />}
                />
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Expected vs actual present biometric logs (6:45 AM View)
                    </p>
                  </div>
                      ...
                      <tbody>
                        {rosterGaps.map((r, idx) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 text-muted-foreground text-[11.5px]">
                              {r.absents}
                            </td>
                            <td className="p-2.5 text-right">
                              <span
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Biometric Gap Substitutions
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Cross-trained operators present this shift
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 max-h-[360px] overflow-y-auto pr-1">
                    {replacementsLog.map((rep) => (
                      <div
                        key={rep.id}
                        className="p-4 rounded-xl border bg-muted/20 space-y-3 text-[12.5px]"
                      >
                        <div>
                          <div className="text-[11px] uppercase tracking-wider font-bold text-red-500 font-mono">
                            Absent Critical Role
                          </div>
              ...
              <div className="rounded-2xl border bg-card p-5 max-w-2xl mx-auto space-y-3 shadow-md">
                <div className="flex items-center gap-2 border-b pb-2">
                  <div className="h-8 w-8 rounded-full bg-emerald-500 text-white grid place-items-center">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-muted-foreground font-mono">
                      Recipient: Mahesh Kapoor (Production Head)
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-slate-100 border border-slate-200 text-slate-800 text-[12.5px] space-y-2 max-w-[400px] leading-relaxed relative">
                  <div className="absolute right-2 top-2 text-[10px] text-slate-400 font-mono">
                    05:47 AM
                  </div>
                  <div className="font-bold text-[#1D9E75]">
                    📍 CNC Line 1 — Morning Shift Alert
                  </div>
                  ...
                  <div className="bg-white/60 p-2.5 rounded-lg border border-slate-300/40 text-[12px]">
                    <strong>Suggested substitutes:</strong>
                    <br />
                    1. Ramesh Kumar → Dinesh Patel (Grade B, available)
                    <br />
                    2. Vijay Sharma → Ajay Trivedi (available Line 2)
                  </div>
                  <p className="text-[11.5px] text-slate-500 italic">
                    Reply YES to confirm swap or click button below.
                  </p>
                </div>
                ...
                <div className="flex gap-2.5 pt-2">
                  ...
                  <button
                    onClick={() => toast.info("WhatsApp call routed to supervisor...")}
                    className="h-9 px-4 rounded-lg border text-[12px] font-medium hover:bg-muted"
                  >
                    Call Supervisor
                  </button>
                </div>
          ...
          {s.id === "1-5" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  <div className="text-[11px] font-bold text-[#1D9E75] uppercase tracking-wider">
                    Normal Status
                  </div>
                  <div className="text-[20px] font-bold text-[#1D9E75] mt-1">4 SKUs</div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  <div className="text-[11px] font-bold text-[#E8A838] uppercase tracking-wider">
                    Reorder Due
                  </div>
                  <div className="text-[20px] font-bold text-[#E8A838] mt-1">8 SKUs</div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  <div className="text-[11px] font-bold text-[#D85A30] uppercase tracking-wider">
                    Critical
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="text-[14.5px] font-bold tracking-tight">
                        Weekly Material Requirement Planning Grid
                      </h4>
                      <p className="text-[12px] text-muted-foreground mt-0.5">
                        Click any row to review auto-generated Purchase Requisition
                      </p>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse text-[12.5px]">
                      ...
                      <tbody>
                        {mrpData.map((m) => (
                          ...
                          >
                            <td className="p-2.5 font-mono text-[11.5px] text-[#2E86AB]">
                              {m.code}
                            </td>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2 text-[12.5px]">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-bold text-[#2E86AB]">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-foreground">
                          {selectedMaterial.vendor}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Shortfall Quantity:</span>
                        <span className="font-mono font-bold text-red-500">
                          {selectedMaterial.shortfall > 0
                            ? `${selectedMaterial.shortfall.toLocaleString()} ${selectedMaterial.unit}`
                            : "No Shortfall"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-bold text-foreground">
                          ₹{selectedMaterial.rate}/{selectedMaterial.unit}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-bold text-primary">
                          ₹
                          {(selectedMaterial.shortfall * selectedMaterial.rate).toLocaleString(
                            "en-IN",
                          )}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-foreground">
                          {selectedMaterial.leadTime} Days
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t">
                      <div className="p-3 rounded-lg border bg-muted/40 text-foreground font-mono text-[11.5px] leading-relaxed">
                        ...
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;"ItemCode":{" "}
                        <span className="text-primary">"{selectedMaterial.code}"</span>,
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;"Volume":{" "}
                        <span className="text-blue-500">{selectedMaterial.shortfall || 1000}</span>,
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;"PreferredVendor":{" "}
                        <span className="text-primary">"{selectedMaterial.vendor}"</span>
                        <br />
                        &nbsp;&nbsp;{"}"}
                        <br />
                        {"}"}
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-2 h-10 rounded-xl font-semibold text-[13px] shadow-sm ${
                        ...
                        selectedMaterial.status === "Stock Out"
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 bg-muted/40 text-foreground flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 font-mono text-[12.5px] shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <strong>Live Roster Tracking:</strong> Morning Shift • Hour 4 (9:00 AM – 10:00
                    AM)
                  </div>
                </div>
                <div>
                  Today Total:{" "}
                  <span className="text-primary font-bold">{totalProducedToday} units</span> •
                  Variance:{" "}
                  <span
                    className={
                      trackerVariance < 0 ? "text-red-500 font-bold" : "text-emerald-500 font-bold"
                    }
                  >
                    {trackerVariance}%
                  </span>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Shop Floor Scoreboard
                    </h4>
                    <span className="text-[11px] text-muted-foreground">
                      Refreshes automatically every 5s
                    </span>
                  </div>
                      ...
                      <tbody>
                        {scoreboardData.map((row) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 text-right">
                              <span
                                className={`inline-block px-2.5 py-0.5 rounded text-[11.5px] font-mono font-bold border ${
                                  row.oee >= 85
                                    ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20"
                                    : row.oee >= 70
                  ...
                  <div className="space-y-4">
                        ...
                        <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${g.val}%`,
                              backgroundColor:
                                g.val >= 85 ? "#1D9E75" : g.val >= 70 ? "#2E86AB" : "#E8A838",
                            }}
                          />
                        </div>
                      </div>
                    ...
                    <div className="pt-4 border-t text-[12px] space-y-2">
                      ...
                      <div className="p-3 rounded-lg border bg-amber-500/5 border-amber-500/20 leading-relaxed text-muted-foreground text-[11.5px]">
                        <strong>Downtime Event INC-9941:</strong> Planned stamping changeover on
                        Line 3 overran by 32m due to locking bolt re-torque issues. Supervisor
                        marked root cause as:{" "}
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 bg-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm">
                ...
                <div className="flex gap-2 shrink-0">
                  <button
                    onClick={handleGenReport17}
                    disabled={reportGenStatus === "generating"}
                    className="inline-flex items-center justify-center gap-1.5 h-9 px-4 rounded-xl bg-primary text-primary-foreground font-semibold hover:opacity-90 disabled:opacity-50 text-[12.5px] shadow-sm"
                  >
                    {reportGenStatus === "generating" ? "Compiling..." : "Generate Preview Now"}
                  </button>
                  <button
                    onClick={() =>
                      toast.success("Test Weekly Report dispatched via WhatsApp/Email.")
                    }
                    className="h-9 px-4 rounded-lg border text-[12px] font-medium hover:bg-muted"
                  >
                    Send Test
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Branded PDF Report Layout Preview
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Click any report page thumbnail to review document content parameters
                    </p>
                  </div>
                    ...
                    {[
                      {
                        ...
                        content:
                          "Overall plant performance metrics compilation, downtime totals, and composite OEE indexes summary.",
                      },
                      {
                        page: 2,
                        title: "OEE Scoreboard",
                        content:
                          "Line-by-line shift adherence percentages, quality audits, availability rates, and speed analysis tables.",
                      },
                      {
                        page: 3,
                        title: "Gantt Schedule",
                        content:
                          "Full week calendar layout of production slots, priority client account allocations, and idle buffers.",
                      },
                      {
                        page: 4,
                        title: "Material Shortfalls",
                        content:
                          "Raw material inventory checks, reorder quantities, PO dispatch lists, and critical stock warnings.",
                      },
                    ].map((p) => (
                      <div
                        key={p.page}
                      ...
                      >
                        <div className="space-y-1">
                          ...
                          <div className="font-bold text-[13px] text-foreground tracking-tight leading-snug">
                            {p.title}
                          </div>
                        </div>
                    ...
                    <div className="p-4 rounded-xl border bg-accent/30 text-[12.5px] space-y-2 animate-fade-in">
                      <div className="flex items-center justify-between border-b pb-2">
                        <strong className="text-primary">
                          Expanded Preview — Page {expandedReportPage}
                        </strong>
                        <button
                          onClick={() => setExpandedReportPage(null)}
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        This section represents a detailed audit matrix dynamically populated from
                        the MES database. The compiled document complies with ISO 9001 reporting
                        standards and is automatically formatted in Rupee currency (Lakhs/Crores)
                        using unified DD/MM/YYYY dates.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Toggle delivery channels for the Monday briefing
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    {reportRecipients.map((rec, i) => (
                      <div
                        key={i}
                        className="p-3 rounded-lg border bg-muted/20 flex items-center justify-between gap-3 text-[12.5px]"
                      >
                        <div>
                  ...
                  <div className="pt-4 border-t space-y-2.5 text-[12px]">
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        <div
                          key={i}
                          className="p-2.5 rounded border bg-accent/20 flex items-center justify-between text-[11.5px] font-mono"
                        >
                          <div>
                            <span className="font-bold text-foreground">
                              {h.week} Planning Report
                            </span>
                            <div className="text-muted-foreground text-[10.5px] mt-0.5">
                              Variance: {h.variance} • Date: {h.date}
                            </div>
                          </div>
                          <button
                            onClick={() => toast.success("Downloading PDF...")}
                            className="h-7 w-7 rounded bg-background border flex items-center justify-center hover:bg-muted shrink-0 text-muted-foreground hover:text-foreground"
                          >
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-[12.5px] text-muted-foreground">
                      Pending requisitions from ERP & AI MRP triggers
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      AI Purchase Order Generation Panel
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Automated vendor selection and pricing card lookup
                    </p>
                  </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                          {[
                            ...
                            <div
                              key={strat}
                              className="p-2.5 rounded-lg border text-center text-[11.5px] font-semibold bg-muted/40 border-primary/20 text-primary"
                            >
                              {strat === "Preferred Vendor" ? "★ " : ""}
                              {strat}
                            </div>
                          ))}
                        </div>
                        <p className="text-[11.5px] text-muted-foreground italic">
                          Selected Vendor: **Mehta Steel Works** ( Ahmedabad GIDC ) - Approved Rate:
                          ₹68.00/kg - Lead Time: 5 days
                        </p>
                      </div>
                  ...
                  {pendingPRs21.length > 0 && (
                    ...
                    >
                      {poGenStatus21 === "generating" ? (
                        <>
                          <Loader2 className="h-4 w-4 animate-spin" /> Compiling PR to PO (ERP
                          Sync)...
                        </>
                      ) : (
                        <>
                  ...
                  <div className="border rounded-xl p-4 bg-muted/10 space-y-4 text-[12px] leading-normal font-sans">
                    <div className="flex justify-between border-b pb-2">
                      ...
                      <div className="text-right">
                        <div className="font-bold text-primary uppercase text-[12px]">
                          Purchase Order
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[11px] border-b pb-3">
                      ...
                      <div>
                        ...
                        <div className="text-muted-foreground font-mono font-semibold text-primary mt-1">
                          Payment: Net 30 Days
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 border-t text-right text-[11px] space-y-1 font-mono">
                      <div className="text-muted-foreground">
                        Basic Amount: ₹{(activePR21?.value ?? 204000).toLocaleString("en-IN")}
                      </div>
                      <div className="text-muted-foreground">
                        GST (18%): ₹
                        {Math.round((activePR21?.value ?? 204000) * 0.18).toLocaleString("en-IN")}
                      </div>
                      <div className="font-bold text-[12.5px] text-foreground border-t pt-1 mt-1">
                        Total PO: ₹
                        {Math.round((activePR21?.value ?? 204000) * 1.18).toLocaleString("en-IN")}
                      </div>
                    </div>
                  </div>
                  ...
                  {poGenStatus21 === "complete" && (
                    <div className="p-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 text-emerald-600 text-[12px] space-y-2 animate-fade-in">
                      ...
                      <div className="bg-background/80 p-2.5 rounded-lg border text-[11.5px] leading-relaxed italic text-foreground/80 font-mono">
                        📋 PO Number: PO-2024-1147. Suresh Mehta notified. Deliver by 25 Jan 2025.
                        Net 30 days. ✓✓
                      </div>
                    </div>
                  )}
              ...
              <div className="rounded-2xl bg-card border p-5">
                <h4 className="text-[14.5px] font-bold tracking-tight mb-3">
                  Issued Purchase Orders Register
                </h4>
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse text-[12.5px]">
                    <thead>
                    ...
                    <tbody>
                      {approvedPOs21.map((p) => (
                        ...
                        >
                          ...
                          <td className="p-2.5 text-muted-foreground font-mono text-[11.5px]">
                            {p.date}
                          </td>
                          <td className="p-2.5 text-right">
          ...
          {s.id === "9-1" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  <div className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider font-sans">
                    Pending POs
                  </div>
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-emerald-500/20">
                  <div className="text-[11px] font-bold text-emerald-600 uppercase tracking-wider font-sans">
                    Auto-follow-ups
                  </div>
                  <div className="text-[20px] font-bold text-emerald-600 mt-1 font-mono">312</div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-amber-500/20">
                  <div className="text-[11px] font-bold text-amber-500 uppercase tracking-wider font-sans">
                    Response Rate
                  </div>
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-destructive/20 animate-pulse">
                  <div className="text-[11px] font-bold text-destructive uppercase tracking-wider font-sans">
                    Late Deliveries
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Vendor Follow-Up Automation — Active Records
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Automated WhatsApp + email follow-ups for ETA, dispatch and docs
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2 text-[12.5px]">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-foreground">
                          {activePO22.transitStatus}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Transporter Link:</span>
                        <span className="font-semibold text-foreground">
                          {activePO22.transporter || "Not Dispatched"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Risk Level:</span>
                        <span
                          className={`font-bold ${activePO22.risk === "High" ? "text-destructive" : activePO22.risk === "Medium" ? "text-amber-500" : "text-emerald-500"}`}
                        >
                          {activePO22.risk}
                        </span>
                      </div>
                    ...
                    <div className="pt-3 border-t space-y-2">
                      <div className="text-[11px] font-bold uppercase text-muted-foreground flex justify-between items-center">
                        ...
                        <span className="text-[9px] text-emerald-500 font-bold bg-emerald-500/10 px-1.5 py-0.25 rounded border border-emerald-500/20">
                          Active
                        </span>
                      </div>
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            ...
                            setOpenPOs22((prev) =>
                              prev.map((p) =>
                                p.id === activePO22.id ? { ...p, channels: updated } : p,
                              ),
                            );
                            toast.success(
                              `WhatsApp reminder channel ${updated.includes("whatsapp") ? "ENABLED" : "DISABLED"} for ${activePO22.vendor}.`,
                            );
                          }}
                        ...
                        <button
                          onClick={() => {
                            ...
                            toast.success(
                              `Email reminder channel ${updated.includes("email") ? "ENABLED" : "DISABLED"} for ${activePO22.vendor}.`,
                            );
                          }}
                          className={`flex-1 h-8 rounded-lg border font-semibold text-[11px] transition-all flex items-center justify-center gap-1 ${
                          ...
                          return (
                            ...
                            >
                              <span className="flex items-center gap-2">
                                <span
                                  className={`h-2 w-2 rounded-full ${isMissing ? "bg-red-500 animate-pulse" : "bg-emerald-500"}`}
                                />
                                <span
                                  className={
                                    isMissing
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  setOpenPOs22((prev) =>
                                    prev.map((p) =>
                                      p.id === activePO22.id
                                        ? { ...p, missingDocs: updatedDocs }
                                        : p,
                                    ),
                                  );
                                  toast.success(
                                    `${doc.label} marked as ${isMissing ? "Collected" : "Missing"} for ${activePO22.vendor}.`,
                                  );
                                }}
                    ...
                    <div className="pt-3 border-t space-y-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            toast.success(
                              `Consolidated WhatsApp nudge dispatched to ${activePO22.vendor}.`,
                            );
                          }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto mt-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Execution track for {activePO22.vendor} ({activePO22.id})
                    </p>
                  </div>
                  ...
                  <div className="relative flex justify-between items-start mt-6 font-sans">
                    ...
                    <div className="absolute top-[18px] left-[5%] right-[5%] h-1 bg-muted rounded">
                      <div
                        ...
                        style={{
                          width: `${(((activePO22.status === "Overdue" || activePO22.status === "Escalated" ? 4 : activePO22.status === "Due Soon" ? 3 : 1) - 1) / 3) * 100}%`,
                        }}
                      />
                    </div>
                    ...
                    {[
                      {
                        ...
                        desc: "Initial ETA request",
                        stage: 1,
                      },
                      {
                        label: "T-2 Days",
                        title: "Automated Email",
                        desc: "Formal reminders",
                        stage: 2,
                      },
                      { label: "T-Day", title: "Portal Alert", desc: "Supplier alert", stage: 3 },
                      {
                        label: "T+2 Days",
                        title: "Buyer Escalation",
                        desc: "Procurement alarm",
                        stage: 4,
                      },
                    ].map((step) => {
                      const activeStage =
                        activePO22.status === "Overdue" || activePO22.status === "Escalated"
                          ? 4
                          : activePO22.status === "Due Soon"
                            ? 3
                            : 1;
                      ...
                      return (
                        <div
                          key={step.stage}
                          className="relative z-10 flex flex-col items-center text-center w-[22%] space-y-2"
                        >
                          <div
                            className={`h-9 w-9 rounded-full flex items-center justify-center font-bold text-[12px] border-2 transition-all duration-300 ${
                              isCompleted
                          ...
                          <div>
                            ...
                            <div className="text-[10px] font-bold text-primary font-mono mt-0.5">
                              {step.label}
                            </div>
                            <div className="text-[9.5px] text-muted-foreground hidden sm:block leading-tight mt-1">
                              {step.desc}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="p-3 bg-muted/30 border rounded-xl text-[11px] text-muted-foreground leading-normal mt-4 font-mono">
                    ...
                    {(activePO22.status === "Overdue" || activePO22.status === "Escalated"
                      ...
                      : activePO22.status === "Due Soon"
                        ? 3
                        : 1) === 4
                      ? "Escalation protocol triggered. Regional buyer has been alerted to expedite procurement."
                      : (activePO22.status === "Overdue" || activePO22.status === "Escalated"
                            ? 4
                            : activePO22.status === "Due Soon"
                              ? 3
                              : 1) === 3
                        ? "T-Day reached. Critical alert posted to supplier dashboard; awaiting Challan upload."
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-3 shadow-sm">
                  <div className="flex items-center gap-2 border-b pb-2">
                    ...
                    <div>
                      <div className="text-[13px] font-bold text-foreground">
                        Follow-up Message Template Preview
                      </div>
                      <div className="text-[10px] text-muted-foreground font-mono">
                  ...
                  <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-800 border text-slate-800 dark:text-slate-200 text-[12.5px] space-y-2 max-w-[400px] leading-relaxed relative font-sans">
                    ...
                    <p>
                      Our PO **{activePO22.id}** for **{activePO22.material}** is expected by **
                      {activePO22.date}**.
                    </p>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-emerald-500/20">
                  ...
                  <div className="text-[20px] font-bold text-emerald-600 mt-1">
                    {grnMatchesApproved23 ? "3" : "2"} Receipts
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-amber-500/20">
                  <div className="text-[11px] font-bold text-amber-500 uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Delivery Challan Scanner
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Scan paper challan to extract metadata
                    </p>
                  </div>
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      AI 3-Way Match Verification
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Real-time discrepancy check against PO lines
                    </p>
                  </div>
                  ...
                  {scanStatus23 === "complete" && !grnMatchesApproved23 && (
                    <div className="p-4 rounded-xl border border-destructive/20 bg-destructive/5 text-foreground text-[12.5px] space-y-3 animate-fade-in">
                      ...
                      <ul className="list-disc pl-4 space-y-1 text-muted-foreground text-[11.5px]">
                        <li>
                          ⚠️ **CRCA Sheet 1.2mm** - 2,840 kg received vs 3,000 kg ordered (160 kg
                          short)
                        </li>
                        <li>
                          🔴 **CRCA Sheet 1.0mm** - Code Mismatch (Challan: RM-CRCA-1.00-HR vs PO:
                          RM-CRCA-1.0)
                        </li>
                      </ul>
                      <div className="flex gap-2 pt-2">
                        ...
                        <button
                          onClick={() => {
                            ...
                            setGrnItems23((prev) =>
                              prev.map((item) =>
                                item.id === 7 ? { ...item, status: "✅ Mapped & Resolved" } : item,
                              ),
                            );
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Scanned bills waiting for 3-way match
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    {invoices24.map((inv) => (
                      ...
                      >
                        ...
                        <div className="text-[13px] font-bold mt-1 text-foreground">
                          {inv.vendor}
                        </div>
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Three-Way Match Verification details
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      PO vs GRN vs Vendor Invoice values
                    </p>
                  </div>
                  ...
                  <div className="border rounded-xl p-4 bg-muted/15 space-y-4 text-[12px]">
                    ...
                    <div className="grid grid-cols-4 py-1 border-t">
                      ...
                      <span
                        className={`text-right font-mono font-bold ${activeInvoice24.rate > activeInvoice24.poRate ? "text-destructive" : "text-foreground"}`}
                      >
                    ...
                    <div className="grid grid-cols-4 py-1.5 border-t font-bold text-[12.5px]">
                      ...
                      <span className="text-center font-mono text-muted-foreground">
                        ₹{activeInvoice24.value.toLocaleString("en-IN")}
                      </span>
                  ...
                  {activeInvoice24.status === "Disputed" && (
                    <div className="p-3.5 rounded-xl border border-red-500/25 bg-red-500/5 text-destructive text-[12px] space-y-1 animate-fade-in leading-relaxed">
                      ...
                      <p className="text-muted-foreground mt-1">
                        Invoice rate **₹{activeInvoice24.rate}** exceeds standard PO rate **₹
                        {activeInvoice24.poRate}** by **+10.0%**. Overcharge: **₹2,700**.
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
                  {[
                    ...
                    >
                      <div className="space-y-1">
                        <div className="font-bold text-[12.5px] text-foreground leading-tight">
                          {buck.label}
                        </div>
                        <div className="text-[18px] font-mono font-bold mt-2 text-foreground">
                          {buck.val}
                        </div>
                      </div>
                      <span
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Coordinated score card aggregates delivery and quality metrics
                    </p>
                  </div>
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div className="border-b pb-2 flex justify-between items-center">
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Scorecard Details: {activeVendor25.name}
                    </h4>
                    <span className="text-[11px] font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded">
                      {activeVendor25.id}
                    </span>
                  ...
                  <div className="space-y-4">
                          ...
                          <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${g.val}%`,
                                backgroundColor:
                                  g.val >= 85 ? "#1D9E75" : g.val >= 70 ? "#2E86AB" : "#D85A30",
                              }}
                            />
                          </div>
                        </div>
                    ...
                    {activeVendor25.score < 60 && (
                      <div className="p-3.5 rounded-xl border border-red-500/25 bg-red-500/5 text-destructive text-[12px] space-y-2 animate-fade-in">
                        <div className="font-bold flex items-center gap-1.5">
                          <ShieldAlert className="h-4 w-4 animate-bounce" /> Performance
                          Intervention Alert
                        </div>
                        <p className="text-muted-foreground leading-normal text-[11.5px]">
                          This vendor is graded **AT RISK** due to chronic delivery delays and
                          quality rejections. Action is recommended to secure component pipelines.
                        </p>
                        <div className="flex gap-2 pt-1.5">
                          ...
                          <button
                            onClick={() =>
                              handleVendorAction25(activeVendor25.id, "volume_reduced")
                            }
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-amber-500/20">
                  ...
                  <div className="text-[20px] font-bold text-amber-500 mt-1 font-mono">
                    2 Categories
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight font-serif">
                      Spend vs Budget Ledger
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Month-to-date category budgets tracking
                    </p>
                  </div>
                        ...
                        {spendData26.map((row) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 text-right font-mono">
                              ₹{row.budget.toFixed(1)}L
                            </td>
                            <td className="p-2.5 text-right font-mono font-bold text-foreground">
                              ₹{row.spent.toFixed(1)}L
                            </td>
                            <td className="p-2.5 text-right">
                              <span
                                className={`inline-block px-2.5 py-0.5 rounded text-[11px] font-semibold border ${
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Actual purchase rates vs standard budget costs
                    </p>
                  </div>
                      ...
                      <tbody>
                        {materials26.map((m) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 text-right text-muted-foreground text-[11.5px] font-mono">
                              {m.trend}
                            </td>
                          </tr>
                        ))}
              ...
              <div className="rounded-2xl border bg-card p-5 max-w-2xl mx-auto space-y-4 shadow-sm">
                ...
                <div className="p-4 rounded-xl bg-muted/30 font-mono text-[11.5px] leading-relaxed text-foreground space-y-2 border">
                  ...
                  <div>
                    • MSME Payments: 8 of 8 payments made within 45 days compliance checks ✓
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-primary">
                      Mobile Shop Floor Form
                    </span>
                    <h4 className="text-[14.5px] font-bold tracking-tight mt-0.5">
                      Simulate Digital QC Check
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Scan QR on job card or enter readings manually
                    </p>
                  </div>
                  ...
                  <div className="space-y-3.5 bg-muted/20 p-4 rounded-xl border text-[12.5px]">
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="text-[10.5px] font-bold text-muted-foreground uppercase">
                          Batch Code
                        </label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-[10.5px] font-bold text-muted-foreground uppercase block mb-1">
                        Wall Thickness (Nominal: 3.00mm, USL: 3.20, LSL: 2.80)
                      </label>
                      <input
                        type="text"
                        value={newInsWall31}
                    ...
                    <div>
                      <label className="text-[10.5px] font-bold text-muted-foreground uppercase block mb-1">
                        Surface Finish (Nominal: Ra 1.6, Limit: Ra 3.2)
                      </label>
                      <input
                        type="text"
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Vatva Quality Inspection Feed
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Chronological record of completed quality checks
                    </p>
                  </div>
              ...
              <div className="rounded-2xl bg-card border p-5 space-y-4">
                <div className="border-b pb-2 flex justify-between items-center">
                  <h4 className="text-[14.5px] font-bold tracking-tight">
                    Inspection Analysis: {activeIns31.id}
                  </h4>
                  <span className="text-[11.5px] font-mono text-muted-foreground">
                    Inspector: {activeIns31.inspector}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3.5 text-[12.5px]">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-foreground">
                        {activeIns31.batch} ({activeIns31.product})
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Inspection Sample Decision:</span>
                      <span className="font-mono font-bold text-foreground">
                        {activeIns31.defects} defects of {activeIns31.sampleSize} units
                      </span>
                    </div>
                    {activeIns31.result === "REJECT" && (
                      <div className="p-3.5 rounded-xl border border-red-500/25 bg-red-500/5 text-destructive space-y-1 leading-relaxed">
                        <div className="font-bold flex items-center gap-1.5">
                          <AlertTriangle className="h-4 w-4 animate-pulse" /> Out-of-Spec Rejection
                          Details
                        </div>
                        <p className="text-muted-foreground mt-1 text-[11.5px]">
                          Defect Type: **{activeIns31.defectType}**. AQL threshold exceeded. Quality
                          hold applied to 1,000 units in batch.
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  ...
                  <div className="text-[20px] font-bold mt-1 font-mono">
                    {ncrList32.filter((n) => n.status !== "Closed").length} NCRs
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-red-500/20">
                  <div className="text-[11px] font-bold text-destructive uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Select non-conformance ticket to route CAPA
                    </p>
                  </div>
                  ...
                  return (
                    <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                      <div>
                        <div className="flex justify-between items-center">
                          <h4 className="text-[14.5px] font-bold tracking-tight">
                            NCR Analysis: {activeNcr.id}
                          </h4>
                          <span className="text-[11px] font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded">
                            {activeNcr.severity} Severity
                          </span>
                        </div>
                        <p className="text-[12px] text-muted-foreground mt-0.5 font-mono">
                          Owner: {activeNcr.owner} • Raised: {activeNcr.date}
                        </p>
                      </div>
                      ...
                      {selectedNcrId32 === "NCR-2024-441" && (
                        <div className="p-3.5 rounded-xl border border-amber-500/25 bg-amber-500/5 text-foreground text-[12px] space-y-1 animate-fade-in leading-relaxed">
                          ...
                          <p className="text-muted-foreground text-[11.5px] mt-1">
                            **3 surface scratch NCRs** detected on CNC Line 1 in the last 90 days.
                            Tooling wear re-checks ordered.
                          </p>
                        </div>
                      )}
                ...
                <div className="h-[200px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Tooltip />
                      <Bar dataKey="count" fill="var(--primary)" radius={[6, 6, 0, 0]} maxBarSize={32} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Interactive Genealogy Tree Structure
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Genealogical mappings for {batchQuery33}
                    </p>
                  </div>
                  ...
                  {traceStatus33 === "tracing" ? (
                    <div className="h-[300px] flex flex-col items-center justify-center space-y-3">
                      ...
                      <span className="text-[12px] text-muted-foreground">
                        Mapping multi-tier Bill of Material tables...
                      </span>
                    </div>
                    ...
                    <div className="border rounded-xl p-4 bg-muted/10 font-mono text-[12px] space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="p-3 rounded-lg border bg-card space-y-1">
                          ...
                          <div className="text-[11.5px] font-semibold text-foreground line-clamp-1">
                            RM-2024-441 (Steel)
                          </div>
                          <div className="text-[11.5px] font-semibold text-foreground line-clamp-1">
                            RM-2024-388 (Zinc)
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Select standards scheme report
                    </p>
                  </div>
                ...
                {(() => {
                  const activeReport =
                    reports34.find((r) => r.id === selectedReportId34) || reports34[0];
                  return (
                    <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                      <div>
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[11.5px] font-mono text-muted-foreground bg-muted px-2 py-0.5 rounded">
                            Revision: Rev 01
                          </span>
                        </div>
                        <p className="text-[12px] text-muted-foreground mt-0.5">
                          Auto-compiled at: {activeReport.date}
                        </p>
                      </div>
                      ...
                      <div className="border rounded-xl p-4 bg-muted/20 text-[12.5px] font-mono leading-relaxed space-y-3.5">
                        ...
                        <div className="border-t pt-2 text-[10px] text-center text-muted-foreground italic">
                          Generated and approved under compliance requirements of Gujarat Factories
                          Act.
                        </div>
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      X-Bar Statistical Process Control Chart
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Shows sample subgroup averages against control limits
                    </p>
                  </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={spcSubgroups35.slice(-20)}>
                        ...
                        <XAxis
                          ...
                          axisLine={false}
                          tick={{ fill: "var(--muted-foreground)", fontSize: 10, fontFamily: "var(--font-mono)" }}
                          label={{ value: "Subgroup #", position: "insideBottom", offset: -2, fill: "var(--muted-foreground)", fontSize: 10, fontFamily: "var(--font-sans)" }}
                        />
                        <YAxis
                          domain={[2.7, 3.3]}
                          tickLine={false}
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  ...
                  <div className="space-y-3.5 max-h-[300px] overflow-y-auto pr-1">
                    {[
                      ...
                      <div
                        key={ctq.name}
                        className="flex justify-between items-center text-[12.5px] border-b pb-2 last:border-0"
                      >
                        <div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Calibration register ledger
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Tracks instrument NABL calibration periods
                    </p>
                  </div>
                      ...
                      <tbody>
                        {instruments36.map((inst) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 text-center font-mono text-[11.5px]">
                              {inst.due}
                            </td>
                            <td
                              className={`p-2.5 text-center font-mono font-bold ${inst.days < 0 ? "text-destructive" : "text-foreground"}`}
                            >
                              {inst.days}
                            </td>
                            <td className="p-2.5 text-right">
                ...
                {(() => {
                  const activeInst =
                    instruments36.find((i) => i.id === selectedInstId36) || instruments36[0];
                  return (
                    <div className="rounded-2xl border bg-card p-5 space-y-4">
                      <div className="border-b pb-2 flex justify-between items-center">
                        <h4 className="text-[14.5px] font-bold tracking-tight">
                        ...
                        <span className="text-[11.5px] font-mono text-primary">
                          {activeInst.id}
                        </span>
                      </div>
                      ...
                      <div className="space-y-4 text-[12.5px]">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold text-foreground">
                            {activeInst.custodian}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Certificate link:</span>
                          <span className="font-mono text-primary underline cursor-pointer">
                            {activeInst.cert}.pdf
                          </span>
                        </div>
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className={`h-9 px-3 rounded-lg border font-semibold hover:bg-muted text-[12px] ${
                                activeInst.hold
                                  ? "text-emerald-600 border-emerald-500/25 bg-emerald-500/5"
                                  : "text-destructive border-destructive/25 bg-destructive/5"
                              }`}
                            >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl bg-card border p-5 space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Complaints inbox linkage
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Select complaint ticket from sales channel
                    </p>
                  </div>
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      AI pre-filled 8D problem solving report
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Complaints linked to Batch {activeComp37.batch} (NCR: {activeComp37.ncr})
                    </p>
                  </div>

                  {/* 8D text panel */}
                  <div className="border rounded-xl p-4 bg-muted/15 space-y-4 text-[12.5px] leading-normal font-sans">
                    <div className="font-bold border-b pb-2 text-[13px]">
                      8D REPORT: {activeComp37.id} — {activeComp37.customer}
                    </div>
                    ...
                    <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
                      <div>
                        ...
                        <div className="text-foreground mt-0.5">
                          Leader: Sunita Patel, Members: Vijay Sharma, Ramesh Kumar
                        </div>
                      </div>
                      <div className="border-t pt-2">
                        ...
                        <div className="text-foreground mt-0.5">
                          Scratches observed on {activeComp37.qty} units out of 1,000 components
                          received. Spec limit exceeded.
                        </div>
                      </div>
                      <div className="border-t pt-2">
                        <span className="font-bold text-primary text-[11px] uppercase">
                        ...
                        <div className="text-foreground mt-0.5">
                          Lot B-4821 segregated in Hold bin B. Replacement cleared and shipped
                          DC-2025-0441.
                        </div>
                      </div>
                      <div className="border-t pt-2">
                        <span className="font-bold text-primary text-[11px] uppercase">
                          D4 — Root Cause Analysis (AI suggested)
                        </span>
                        <div className="text-foreground mt-0.5">
                          Micro-vibrations from worn fixture pad on CNC-01 station. Pattern matched
                          to NCR-2024-431 & NCR-2024-398.
                        </div>
                      </div>

                      {/* Manual D5 to D8 fields inputs */}
                      <div className="border-t pt-2.5 space-y-3">
                        <span className="font-bold text-primary text-[11px] uppercase block">
                          Provide D5-D8 corrective actions (signed off)
                        </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setD5ToD8Answers37((prev) => ({
                                  ...prev,
                                  [activeComp37.id]: {
                                    ...(prev[activeComp37.id] || {
                                      d5: "",
                                      d6: "",
                                      d7: "",
                                      d8: "",
                  ...
                  <div className="flex gap-2.5 pt-3 border-t">
                    <button
                      onClick={() =>
                        handleSave8DAnswers37(
                          activeComp37.id,
                          d5ToD8Answers37[activeComp37.id] || { d5: "", d6: "", d7: "", d8: "" },
                        )
                      }
                    ...
                    <button
                      onClick={() =>
                        toast.success("8D Report PDF exported and sent to customer via email.")
                      }
                      className="h-10 px-4 rounded-xl border font-bold hover:bg-muted text-[13px]"
                    >
                      Export PDF
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-primary/10 via-primary/5 to-card shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      WhatsApp Channel: Online & Active
                    </div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[11.5px] font-mono text-muted-foreground">
                    Original Language Translation: Auto
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between min-h-[500px] space-y-4">
                  <div className="border-b pb-3 flex justify-between items-center">
                    <div>
                      <h4 className="text-[14.5px] font-bold tracking-tight text-foreground">
                        {selectedDealer41}
                      </h4>
                  ...
                  <div className="flex-1 overflow-y-auto max-h-[350px] space-y-3 pr-1.5 min-h-[280px]">
                    {(messages41[selectedDealer41] || []).map((msg, idx) => (
                      <div
                        key={idx}
                        className={`flex ${msg.sender === "dealer" ? "justify-start" : "justify-end"}`}
                      >
                        <div
                          className={`max-w-[80%] rounded-2xl p-3.5 text-[13px] leading-relaxed shadow-sm relative ${
                            msg.sender === "dealer"
                    ...
                    {typing41 && (
                      <div className="flex justify-end">
                        <div className="bg-primary text-primary-foreground/80 rounded-2xl rounded-tr-none p-3.5 text-[12px] flex items-center gap-1.5 shadow-sm">
                          <Loader2 className="h-3.5 w-3.5 animate-spin" /> AI Agent is typing
                          response...
                        </div>
                      </div>
                    )}
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Today's Inbound Query Log
                    </h4>
                    <p className="text-[12px] text-muted-foreground">
                      All dealer WhatsApp requests logged at Vatva Hub
                    </p>
                  </div>
                  ...
                  <div className="space-y-2.5 overflow-y-auto max-h-[360px] pr-1.5">
                    {queryLog41.map((log, idx) => (
                      <div
                        key={idx}
                        className="p-3 rounded-xl border bg-muted/20 flex flex-col justify-between gap-1.5 text-[12px]"
                      >
                        <div className="flex justify-between items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                  ...
                  <div className="text-[20px] font-bold text-primary mt-0.5 font-mono">
                    9 Orders
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-3.5 shadow-sm">
                ...
                <div className="rounded-xl border bg-card p-3.5 shadow-sm border-emerald-500/20">
                  ...
                  <div className="text-[20px] font-bold text-emerald-600 mt-0.5 font-mono">
                    81.8%
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between">
                  <div className="flex justify-between items-center">
                    <div>
                      <h4 className="text-[14.5px] font-bold tracking-tight">
                        Today's Inbound Orders Log
                      </h4>
                      <p className="text-[12px] text-muted-foreground">
                        Select an order record to inspect validation checks
                      </p>
                    </div>
                    <button
                  ...
                  <div className="space-y-3 bg-muted/20 p-4 rounded-xl border text-[12.5px] leading-relaxed">
                    ...
                    <div className="space-y-2.5 pt-1.5">
                      ...
                      <div className="flex justify-between items-center text-[12px]">
                        ...
                        {activeOrder42.status.includes("Hold") ? (
                          <span className="text-red-500 font-bold font-mono animate-pulse">
                            ⚠️ WARN (Overlimit)
                          </span>
                        ) : (
                          <span className="text-emerald-600 font-bold font-mono">✓ PASS</span>
                    ...
                    {activeOrder42.status.includes("Hold") && (
                      <div className="p-3.5 rounded-lg border border-amber-500/25 bg-amber-500/5 text-amber-700 space-y-1 text-[11.5px] mt-2">
                        ...
                        <p className="mt-0.5">
                          Account has ₹4.64L outstanding + new order value exceeds the ₹15L credit
                          threshold. Needs Sales Manager override.
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border bg-card p-4 shadow-sm border-emerald-500/20">
                  ...
                  <div className="text-[24px] font-bold text-emerald-600 mt-1 font-mono">
                    4 Invoices
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm border-red-500/20">
                  ...
                  <div className="text-[24px] font-bold text-destructive mt-1 font-mono animate-pulse">
                    2 Warnings
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Vatva Logistics Dispatch Ledger
                    </h4>
                    <p className="text-[12px] text-muted-foreground">
                      Select a shipment to track LR status and trigger manual override alerts
                    </p>
                  </div>
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Today's Dispatch Push Log
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Automated WhatsApp dispatches status
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 overflow-y-auto max-h-[300px] pr-1 flex-1">
                    {notificationsSent43.map((notif, idx) => (
                      <div
                        key={idx}
                        className="p-3 rounded-xl border bg-muted/20 flex flex-col gap-1 text-[11.5px] leading-relaxed"
                      >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="rounded-xl border bg-card p-4 shadow-sm border-amber-500/20">
                  ...
                  <div className="text-[24px] font-bold text-amber-500 mt-1 font-mono">
                    3 Dealers
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm border-emerald-500/20">
                  <div className="text-[11px] font-bold text-emerald-600 uppercase tracking-wider">
                    Fast Movers Identified
                  </div>
                  <div className="text-[24px] font-bold text-emerald-600 mt-1 font-mono text-emerald-500">
                    4 Items
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Gujarat Secondary Sell-Out Matrix
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Product-wise dealer inventory cover tracking matrix
                    </p>
                  </div>
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Active Inventory Stagnation Alerts
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Automated recommendations for overstock/deficit
                    </p>
                  </div>
                  ...
                  <div className="space-y-3.5 flex-1 overflow-y-auto max-h-[300px]">
                    <div className="p-3.5 rounded-xl border border-red-500/25 bg-red-500/5 space-y-2 text-[12px]">
                      ...
                      <div className="text-muted-foreground leading-relaxed">
                        Item: **PC-118** | Primary shipped last 30d: **600 units**. Secondary sold:
                        **82 units**. Closing stock cover: **189 days**.
                      </div>
                      <div className="flex gap-2 pt-1 border-t">
                        <button
                          onClick={() =>
                            handleAddressStagnation44(
                              "Sharma Distributors, Vadodara",
                    ...
                    <div className="p-3.5 rounded-xl border border-amber-500/25 bg-amber-500/5 space-y-2 text-[12px]">
                      ...
                      <div className="text-muted-foreground leading-relaxed">
                        Item: **SP-044** | Primary shipped: **800 units**. Closing stock: **560
                        units**. Days of cover: **70 days**.
                      </div>
                      <div className="flex gap-2 pt-1 border-t">
                        <button
                          onClick={() =>
                            handleAddressStagnation44("Jain Traders, Surat", "Hold Next Dispatch")
                          }
                          className="flex-1 h-7 rounded bg-primary text-primary-foreground font-semibold text-[11px]"
                        >
                          Hold Dispatch
                  ...
                  <div className="border-t pt-3 text-center">
                    <button
                      onClick={() =>
                        toast.success(
                          "Weekly stock inquiry nudges compiled & dispatched to 84 dealers via WhatsApp.",
                        )
                      }
                      className="w-full h-10 rounded-xl bg-primary text-primary-foreground font-bold hover:opacity-90 text-[12.5px]"
                    >
            ...
            <div className="space-y-6">
                ...
                <div className="rounded-xl border bg-card p-4 shadow-sm border-red-500/20">
                  ...
                  <div className="text-[20px] font-bold text-destructive mt-1 font-mono animate-pulse">
                    ...
                    {(
                      receivables45
                        .filter((r) => r.days > 30)
                        .reduce((sum, r) => sum + r.amount, 0) / 100000
                    ).toFixed(2)}
                    L
                  </div>
                  <div className="text-[10px] text-red-500/80 mt-0.5">
                    Critical collections focus
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm">
                  <div className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
                  ...
                  <div className="text-[20px] font-bold mt-1 font-mono">
                    ...
                    {(
                      receivables45
                        .filter((r) => r.days > 15 && r.days <= 30)
                        .reduce((sum, r) => sum + r.amount, 0) / 100000
                    ).toFixed(2)}
                    L
                  </div>
                  <div className="text-[10px] text-muted-foreground mt-0.5">
                    Aged warning threshold
                  </div>
                </div>
                <div className="rounded-xl border bg-card p-4 shadow-sm">
                  <div className="text-[11px] font-bold text-primary uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Receivables Ageing Log
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Select an overdue invoice to dispatch collection notices
                    </p>
                  </div>
                      ...
                      <tbody>
                        {receivables45.map((rec) => (
                          ...
                          >
                            ...
                            <td className="p-2.5 font-semibold text-muted-foreground text-[11.5px]">
                              {rec.region}
                            </td>
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Auto-Collections Action Desk
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Chasing Invoice: {activeReceivable45.inv}
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 flex-1 bg-muted/20 p-4 rounded-xl border text-[12.5px] leading-relaxed">
                    <div className="flex justify-between border-b pb-2">
                      ...
                      <span className="font-bold text-foreground font-mono">
                        ₹{(activeReceivable45.amount / 100000).toFixed(2)}L
                      </span>
                    </div>
                    ...
                    <div className="space-y-1.5 pt-2.5 border-t font-sans">
                      <div className="flex justify-between text-[11px] font-medium">
                        ...
                        <span className="font-mono text-foreground">
                          ₹{(activeReceivable45.creditUtilized / 100000).toFixed(1)}L / ₹
                          {(activeReceivable45.creditLimit / 100000).toFixed(1)}L Limit
                        </span>
                      </div>
                      <div className="w-full bg-muted rounded-full h-1.5 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, (activeReceivable45.creditUtilized / activeReceivable45.creditLimit) * 100)}%`,
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1 pt-2.5 border-t font-sans">
                      <label className="text-[10px] font-bold text-muted-foreground uppercase block font-sans">
                        Outstanding Ageing Distribution
                      </label>
                      <div className="flex flex-wrap gap-1.5 mt-1 font-mono text-[10px]">
                        <span
                          className={`px-2 py-1 rounded border ${activeReceivable45.days <= 0 ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-bold" : "bg-muted text-muted-foreground border-transparent"}`}
                        >
                          Current: ₹
                          {activeReceivable45.days <= 0
                            ? (activeReceivable45.amount / 100000).toFixed(2)
                            : "0"}
                          L
                        </span>
                        <span
                          className={`px-2 py-1 rounded border ${activeReceivable45.days > 0 && activeReceivable45.days <= 30 ? "bg-amber-500/10 text-amber-600 border-amber-500/20 font-bold" : "bg-muted text-muted-foreground border-transparent"}`}
                        >
                          15-30d: ₹
                          {activeReceivable45.days > 0 && activeReceivable45.days <= 30
                            ? (activeReceivable45.amount / 100000).toFixed(2)
                            : "0"}
                          L
                        </span>
                        <span
                          className={`px-2 py-1 rounded border ${activeReceivable45.days > 30 ? "bg-red-500/10 text-red-600 border-red-500/20 font-bold animate-pulse" : "bg-muted text-muted-foreground border-transparent"}`}
                        >
                          &gt;30d: ₹
                          {activeReceivable45.days > 30
                            ? (activeReceivable45.amount / 100000).toFixed(2)
                            : "0"}
                          L
                        </span>
                    ...
                    <div className="border-t pt-2.5 space-y-2 mt-2">
                      <label className="text-[10.5px] font-bold text-muted-foreground uppercase block font-sans">
                        Register Commitment Date
                      </label>
                      <input
                        type="date"
                  ...
                  <div className="border-t pt-3 space-y-2">
                    ...
                    <button
                      onClick={() => {
                        const inputDate =
                          (document.getElementById("commitmentDateInput") as HTMLInputElement)
                            ?.value || "28 Jan";
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                ...
                <div className="xl:col-span-2 rounded-2xl bg-card border p-5 space-y-4 flex flex-col justify-between">
                  <div>
                    <h4 className="text-[14.5px] font-bold tracking-tight">
                      Dealers Onboarding Pipeline
                    </h4>
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      Digital onboarding verification stages
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                    {["applied", "kyc", "credit"].map((stageName) => (
                      <div
                        key={stageName}
                        className="rounded-xl border bg-muted/10 p-3 min-h-[220px] flex flex-col space-y-2"
                      >
                ...
                <div className="rounded-2xl bg-card border p-5 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-[12px] text-muted-foreground mt-0.5">
                      {activeApp46.name} ({activeApp46.city})
                    </p>
                  </div>

                  <div className="space-y-3 bg-muted/20 p-4 rounded-xl border text-[12px] leading-relaxed">
                    <div className="font-bold border-b pb-1.5 uppercase text-primary text-[10.5px]">
                    ...
                    <div className="font-bold border-b pb-1.5 uppercase text-primary text-[10.5px] mt-3">
                      Document Checklist
                    </div>
                  ...
                  <div className="border-t pt-3 space-y-2">
                    ...
                    <button
                      onClick={() => {
                        toast.success(
                          `Welcome Kit WhatsApp packet dispatched to ${activeApp46.name}! Portal login credentials active.`,
                        );
        ...
        <div className="space-y-6">
          ...
          {s.id === "6-2" && (
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border px-5 py-3 bg-card flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px]">
                <span className="font-semibold text-foreground">
                  OEE <span className="font-mono text-primary ml-1">79%</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Lines Online <span className="font-mono text-primary ml-1">5/6</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Output <span className="font-mono text-primary ml-1">1,285/hr</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Shift Total <span className="font-mono text-primary ml-1">6,240</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Variance <span className="font-mono text-destructive ml-1">-11.9%</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Handover{" "}
                  <span
                    className={`font-mono ml-1 ${m62HandoverStatus === "acknowledged" ? "text-[#1D9E75]" : "text-amber-500"}`}
                  >
                    {m62HandoverStatus === "acknowledged" ? "✓ Accepted" : "⚠️ Pending"}
                  </span>
                </span>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Line-by-Line Production Telemetry
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Select a line to view detailed OEE component breakdown
                      </p>
                    </div>
                  </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="p-4.5 text-center">
                                <span
                                  className={`inline-block w-2.5 h-2.5 rounded-full shrink-0 mr-1.5 ${
                                    line.status === "Below Target"
                              ...
                              <td
                                className={`p-4.5 text-right font-extrabold ${line.oee >= 80 ? "text-[#1D9E75]" : line.oee >= 70 ? "text-[#E8A838]" : "text-[#D85A30]"}`}
                              >
                                {line.oee}%
                              </td>
                            </tr>
                  ...
                  {m62OeeComponents[m62SelectedLine] ? (
                    <div className="rounded-2xl border bg-card p-5 space-y-5 shadow-sm">
                      <div className="flex items-center justify-between border-b pb-3">
                        ...
                        <div
                          className={`text-2xl font-black font-mono ${
                            m62OeeComponents[m62SelectedLine].composite >= 80
                              ? "text-[#1D9E75]"
                              : m62OeeComponents[m62SelectedLine].composite >= 70
                                ? "text-warning"
                                : "text-danger"
                          }`}
                        >
                      ...
                      <div className="space-y-3.5">
                        <div className="space-y-1">
                          <div className="flex justify-between text-[12px] font-mono">
                            ...
                            <span className="font-bold text-foreground">
                              {m62OeeComponents[m62SelectedLine].avail}%{" "}
                              <span className="text-muted-foreground font-normal">
                                / {m62OeeComponents[m62SelectedLine].availTarget}%
                              </span>
                            </span>
                          </div>
                          <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${m62OeeComponents[m62SelectedLine].avail}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between text-[12px] font-mono">
                            ...
                            <span className="font-bold text-foreground">
                              {m62OeeComponents[m62SelectedLine].perf}%{" "}
                              <span className="text-muted-foreground font-normal">
                                / {m62OeeComponents[m62SelectedLine].perfTarget}%
                              </span>
                            </span>
                          </div>
                          <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              className="h-full bg-[#E8A838] rounded-full transition-all"
                              style={{ width: `${m62OeeComponents[m62SelectedLine].perf}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between text-[12px] font-mono">
                            ...
                            <span className="font-bold text-foreground">
                              {m62OeeComponents[m62SelectedLine].qual}%{" "}
                              <span className="text-muted-foreground font-normal">
                                / {m62OeeComponents[m62SelectedLine].qualTarget}%
                              </span>
                            </span>
                          </div>
                          <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${m62OeeComponents[m62SelectedLine].qual}%` }}
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 border-t pt-4">
                        <div className="text-[11.5px] font-bold text-muted-foreground uppercase tracking-wider">
                          Root Cause Flags
                        </div>
                        <ul className="space-y-2">
                          {m62OeeComponents[m62SelectedLine].notes.map((note, index) => (
                            <li
                              key={index}
                              className="text-[12px] text-foreground leading-normal flex items-start gap-1.5"
                            >
                      ...
                      {m62OeeComponents[m62SelectedLine].ticket && (
                        <div className="p-3 bg-red-500/5 border border-red-500/20 rounded-xl space-y-1 text-[11.5px] font-mono">
                          <div className="font-bold text-[#D85A30] flex items-center gap-1.5">
                            <AlertCircle className="h-3.5 w-3.5" /> Maintenance Ticket #
                            {m62OeeComponents[m62SelectedLine].ticket?.id}
                          </div>
                          <div className="text-muted-foreground">
                            System: {m62OeeComponents[m62SelectedLine].ticket?.desc}
                          </div>
                          <div className="flex justify-between pt-1">
                            <span>
                              Status:{" "}
                              <strong className="text-amber-500">
                                {m62OeeComponents[m62SelectedLine].ticket?.status}
                              </strong>
                            </span>
                    ...
                    <div className="text-center py-20 border rounded-2xl bg-card">
                      ...
                      <p className="text-[12.5px] text-muted-foreground">
                        Select a line to view diagnostic telemetry.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    ...
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Top 6 downtime categories by cumulative hours lost this month
                    </p>
                  </div>
                  ...
                  <div className="space-y-2 font-mono text-[12px]">
                    {m62DowntimePareto.map((item, idx) => (
                      <div key={idx} className="flex items-center gap-3">
                        <span className="text-muted-foreground w-28 truncate font-sans text-[11.5px]">
                          {item.name}
                        </span>
                  ...
                  <div className="text-[11.5px] text-muted-foreground text-center font-mono pt-1">
                    Unplanned Tooling & Breakdowns account for{" "}
                    <strong className="text-foreground">60.0%</strong> of total monthly capacity
                    leak.
                  </div>
                </div>
                ...
                <div className="rounded-2xl border bg-card p-5 flex flex-col justify-between gap-4">
                  <div className="space-y-3">
                    <div className="flex justify-between items-start">
                      <div>
                        <h3 className="text-[15px] font-bold text-foreground">
                          Automated Shift Handover Log
                        </h3>
                        <p className="text-[11.5px] text-muted-foreground mt-0.5">
                          Morning shift → Afternoon shift • 2:00 PM
                        </p>
                      </div>
                      <span
                        className={`inline-flex px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                          m62HandoverStatus === "acknowledged"
                    ...
                    <div className="bg-muted/30 border p-3 rounded-xl space-y-2 text-[12.5px] font-mono max-h-[145px] overflow-y-auto leading-normal">
                      ...
                      <div>
                        • Outages: CNC Line 1 down 38 min for broken tooling inserts (see ticket
                        MT-441).
                      </div>
                      <div>
                        • Watchlist items: CNC coolant pressure requires verification, and high
                        priority order SO-4822 (Tata AutoComp) must complete machining.
                      </div>
                      <div className="text-[11.5px] text-muted-foreground pt-1 border-t">
                        Outgoing Production Lead: Mahesh Kapoor
                      </div>
                    </div>
                  </div>
          ...
          {s.id === "6-3" && (
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border px-5 py-3 bg-card flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px]">
                <span className="font-semibold text-foreground">
                  SKUs <span className="font-mono text-primary ml-1">1,847</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Normal <span className="font-mono text-[#1D9E75] ml-1">7</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Reorder <span className="font-mono text-amber-500 ml-1">3</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Critical <span className="font-mono text-destructive ml-1">2</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Stock Out <span className="font-mono text-destructive ml-1">1</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Value <span className="font-mono text-primary ml-1">₹1.34 Cr</span>
                </span>
              </div>
                  ...
                  <div className="rounded-2xl border bg-card overflow-hidden shadow-sm">
                    <table className="w-full text-left text-[12.5px]">
                      ...
                      <tbody className="divide-y font-mono">
                        {m63Items
                          .filter((item) => {
                            if (m63CategoryFilter !== "All" && item.category !== m63CategoryFilter)
                              return false;
                            if (m63SlowMovingOnly && !item.slowMoving) return false;
                            if (
                              m63SearchQuery &&
                              !item.code.toLowerCase().includes(m63SearchQuery.toLowerCase()) &&
                              !item.name.toLowerCase().includes(m63SearchQuery.toLowerCase())
                            )
                              return false;
                            return true;
                          })
                            ...
                            return (
                              <tr key={item.id} className="hover:bg-muted/30 transition-colors">
                                <td className="p-4">
                                  ...
                                  <div className="text-[11.5px] text-muted-foreground font-sans mt-0.5">
                                    {item.name}
                                  </div>
                                </td>
                                ...
                                <td
                                  className={`p-4 text-right font-bold ${isCritical ? "text-danger" : isReorder ? "text-warning" : "text-foreground"}`}
                                >
                                  {item.daysCover} days
                                </td>
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-3.5 shadow-sm">
                    <div>
                      ...
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Valuation of inventory in production queue
                      </p>
                    </div>
                    ...
                    <div className="space-y-2.5 font-mono">
                      {wipStages.map((stage, idx) => (
                        <div
                          key={idx}
                          className="flex justify-between items-center text-[12px] border-b pb-1.5"
                        >
                          <span className="text-muted-foreground font-sans truncate pr-2">
                            {stage.stage}
                          </span>
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-3.5 shadow-sm">
                    <div>
                      <h3 className="text-[14.5px] font-bold text-foreground">
                        Finished Goods Shortfalls
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Committed sales orders vs stock on hand
                      </p>
                    </div>
                    ...
                    <div className="space-y-2.5 font-mono">
                      {fgPosition.map((fg, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className="flex justify-between items-center text-[12.5px] border-b pb-1.5"
                          >
                            <span className="text-foreground font-bold">{fg.code}</span>
                            <span className="text-muted-foreground truncate font-sans px-2">
                              FG: {fg.stock}
                            </span>
                            <span
                              className={`shrink-0 font-extrabold px-1.5 py-0.25 rounded text-[11.5px] ${
                                isShortfall
          ...
          {s.id === "6-4" && (
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border px-5 py-3 bg-card flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px]">
                <span className="font-semibold text-foreground">
                  Orders <span className="font-mono text-primary ml-1">₹4.20 Cr</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Revenue <span className="font-mono text-primary ml-1">₹3.80 Cr</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Backlog <span className="font-mono text-[#1D9E75] ml-1">₹8.60 Cr</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Accounts <span className="font-mono text-primary ml-1">14</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  Avg Ticket <span className="font-mono text-primary ml-1">₹15.0L</span>
                </span>
                <span className="text-muted-foreground">•</span>
                <span className="font-semibold text-foreground">
                  OTD <span className="font-mono text-amber-500 ml-1">87%</span>
                </span>
              </div>
              ...
              {m64ActiveTab === "overview" && (
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Year-over-Year Invoiced Growth
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        FY 2024-25 vs FY 2023-24 Monthly Invoiced Comparison (₹ Crores)
                      </p>
                    </div>
                          ...
                          {[
                            ...
                            return (
                              <tr key={i} className="hover:bg-muted/30">
                                ...
                                <td className="p-2.5 text-right text-[#1D9E75] font-extrabold">
                                  +{growth}%
                                </td>
                              </tr>
                            );
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Customer Concentration & YoY Risk
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Top 5 Gujarat-based customer accounts by MTD invoiced volume (₹ Lakhs)
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-red-500/5 border border-red-500/10 rounded-xl text-[12px] flex items-start gap-2 text-foreground">
                      ...
                      <div className="leading-snug font-mono">
                        <strong className="text-[#D85A30]">Concentration risk:</strong> Top 2
                        accounts constitute <strong className="text-foreground">37.4%</strong> of
                        MTD revenue.
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4">
                    <div>
                      ...
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Month-to-date revenue share by product group
                      </p>
                    </div>
                    ...
                    <div className="h-[220px] flex items-center justify-center">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            data={[
                              { name: "CRCA Sheet Components", value: 164, color: "var(--color-primary)" },
                              { name: "Precision Castings", value: 98, color: "var(--color-chart-3)" },
                              { name: "Stamped Parts", value: 76, color: "var(--color-warning)" },
                              { name: "Custom Fabrication", value: 42, color: "var(--color-chart-4)" },
                            ]}
                            cx="50%"
                            cy="50%"
                            innerRadius={60}
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4">
                    <div>
                      ...
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        BOM cost margins by product category
                      </p>
                    </div>
              ...
              {m64ActiveTab === "pipeline" && (
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                  ...
                  <div className="xl:col-span-3 space-y-4">
                        ...
                        <tbody className="divide-y">
                          {m64Opportunities.map((opp) => (
                            <tr key={opp.id} className="hover:bg-muted/30">
                              ...
                              <td className="p-3 text-right text-[#1D9E75] font-extrabold">
                                ₹{Math.floor((opp.value * opp.prob) / 100)}L
                              </td>
                            </tr>
                          ))}
                        </tbody>
                    ...
                    <form
                      onSubmit={handleCreateOpportunity64}
                      className="rounded-2xl border bg-card p-4 space-y-3.5"
                    >
                      <div className="text-[13px] font-bold text-foreground">
                  ...
                  <div className="xl:col-span-2 space-y-4">
                    <h3 className="text-[15px] font-bold text-foreground">
                      Pipeline weighted forecast horizons
                    </h3>
                    ...
                    <div className="rounded-2xl border bg-card p-5 space-y-4">
                      <div className="flex justify-between items-center border-b pb-2">
                        <div>
                          ...
                          <div className="text-[15px] font-black text-foreground font-mono">
                            ₹4.80 Cr
                          </div>
                        </div>
                        <span className="text-[10.5px] font-extrabold text-[#1D9E75] bg-[#1D9E75]/10 px-2 py-0.5 rounded">
                          Avg 75% Prob
                        </span>
                      </div>
          ...
          {s.id === "6-5" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4">
                <KpiCard
                  label="MTD Invoiced Rev"
                  value="₹3.80 Cr"
                  delta="FY24-25 Daily sync"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Monthly Cost Head Variance
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Budgeted vs Actual Cost of Goods (₹ Lakhs)
                      </p>
                    </div>
                    <button
                  ...
                  <div className="h-[240px]">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        />
                        <Tooltip />
                        <Bar dataKey="budget" name="Budget" fill="var(--color-chart-4)" radius={[3, 3, 0, 0]} />
                        <Bar dataKey="actual" name="Actual" fill="var(--primary)" radius={[3, 3, 0, 0]} />
                        <Legend wrapperStyle={{ fontSize: 10, fontFamily: "var(--font-sans)", color: "var(--muted-foreground)" }} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      EBITDA Bridge Build (Waterfall)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      January 2025 MTD operational EBITDA build (₹ Lakhs)
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-3.5">
                  <div>
                    <h3 className="text-[14.5px] font-bold text-foreground">
                      Material Purchase Rate Variances
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Standard Rate vs Actual Invoiced Rate from ERP
                    </p>
                  </div>
                        ...
                        {m65MaterialVariances.map((mv) => {
                          ...
                          return (
                            <tr key={mv.id} className="hover:bg-muted/30">
                              ...
                              <td
                                className={`p-3 text-right font-extrabold ${isAdverse ? "text-danger" : "text-success"}`}
                              >
                                {mv.variance > 0 ? `+${mv.variance}` : mv.variance}%
                              </td>
                              <td
                                className={`p-3 text-right font-black ${isAdverse ? "text-danger" : "text-success"}`}
                              >
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[14.5px] font-bold text-foreground">
                      Receivables Outstanding Aging (Tally Sync)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Outstanding invoice collections status aging buckets
                    </p>
                  </div>
                  ...
                  <div className="text-[11px] text-muted-foreground leading-normal font-mono border-t pt-3">
                    Overdue collections exceeding 60 days currently constitute{" "}
                    <strong className="text-foreground">₹18.4 Lakhs</strong> — requiring direct
                    legal notification.
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4">
                <KpiCard
                  ...
                  value="90.9%"
                  delta="291 present today"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="OT vs Budget MTD"
                  value="120%"
                  delta="384 hrs used / 320 budget"
                  tone="danger"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Direct labor productivity"
                  value="92.3%"
                  delta="Benchmark: 48 units/shift"
                  tone="warning"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  ...
                  value="7 employees"
                  delta="ISO audit in 24 days"
                  tone="danger"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Active Contract Head"
                  value="38 workers"
                  delta="Daily cost billing: ₹57k"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      Department Biometric Attendance (Today)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      ZKTeco active morning & afternoon shifts synchronization
                    </p>
                  </div>
                        ...
                        {m66AttendanceHeatmap.map((dept, idx) => {
                          ...
                          return (
                            <tr key={idx} className="hover:bg-muted/30">
                              ...
                              <td
                                className={`p-3 text-right font-extrabold ${isUnder ? "text-danger" : "text-foreground"}`}
                              >
                                {dept.pct}%
                              </td>
                              <td className="p-3 text-center">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      Monthly Overtime usage by Department
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Budgeted vs Used OT Capacity Hours (MTD)
                    </p>
                  </div>
                  ...
                  <div className="h-[210px]">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip />
                        <Bar dataKey="budget" name="Budget" fill="var(--color-chart-4)" radius={[3, 3, 0, 0]} />
                        <Bar dataKey="used" name="Used" fill="var(--primary)" radius={[3, 3, 0, 0]} />
                        <Legend wrapperStyle={{ fontSize: 10, fontFamily: "var(--font-sans)", color: "var(--muted-foreground)" }} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                    <div>
                      <h3 className="text-[14.5px] font-bold text-foreground">
                        Operator Output Efficiency League
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Operator shift volume vs standard output targets
                      </p>
                    </div>
                    <input
                      type="text"
                      ...
                      <tbody className="divide-y font-mono">
                        {m66Operators
                          .filter(
                            (op) =>
                              !m66OperatorSearch ||
                              op.name.toLowerCase().includes(m66OperatorSearch.toLowerCase()),
                          )
                          .map((op) => {
                            ...
                            return (
                              <tr key={op.id} className="hover:bg-muted/30">
                                ...
                                <td
                                  className={`p-3 text-right font-extrabold ${isLow ? "text-danger" : "text-foreground"}`}
                                >
                                  {op.pct}%
                                </td>
                                <td className="p-3 text-center">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[14.5px] font-bold text-foreground">
                      Safety Training Compliance (ISO 9001)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Mandatory certifications & due dates
                    </p>
                  </div>
                    ...
                    {m66Training.map((tr, idx) => {
                      ...
                      return (
                        <div key={idx} className="flex justify-between items-center border-b pb-2">
                          <div>
                            <span className="text-foreground font-bold font-sans block">
                              {tr.type}
                            </span>
                            <span className="text-[10.5px] text-muted-foreground">
                              Due: {tr.earliest} • Overdue:{" "}
                              <strong className="text-foreground">{tr.overdue}</strong>
                            </span>
                          </div>

                          <div className="flex items-center gap-3">
                            <span
                              className={`inline-flex px-1.5 py-0.25 rounded text-[9.5px] font-black uppercase tracking-wider ${
                                isCritical
                                  ? "bg-red-500/15 text-red-500 animate-pulse"
                                  : "bg-amber-500/10 text-amber-500"
                              }`}
          ...
          {s.id === "7-1" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Live Telephony Call Monitor
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Real-time helpline simulator for incoming queries
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="rounded-2xl border bg-card p-8 text-center flex flex-col items-center justify-center min-h-[340px] space-y-4 shadow-sm border-dashed">
                      ...
                      <div className="space-y-1">
                        <h4 className="text-[14px] font-bold text-foreground">
                          Toll-Free Helpline: 1800-FORTIV-AI
                        </h4>
                        <p className="text-[12px] text-muted-foreground max-w-sm">
                          helpline is currently idle and waiting for incoming order status, price,
                          or dispatch queries.
                        </p>
                      </div>
                      <button
                    ...
                    <div className="rounded-2xl border bg-card p-5 flex flex-col justify-between min-h-[340px] shadow-sm space-y-4">
                      <div className="flex justify-between items-start border-b pb-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-[13.5px] font-bold text-foreground">
                              {m71ActiveCall.account}
                            </div>
                            <span className="inline-flex items-center gap-1.5 text-[10.5px] text-muted-foreground font-mono mt-0.5">
                              {m71ActiveCall.caller} •{" "}
                              <span className="text-primary font-bold">{m71ActiveCall.lang}</span>
                            </span>
                          </div>
                        </div>
                            ...
                            <div
                              ...
                              className={`p-2 rounded-xl max-w-[85%] ${
                                isAI
                                  ...
                                  : "bg-[#2E86AB]/10 text-foreground ml-auto text-right"
                              }`}
                            >
                  ...
                  {m71QueryActive ? (
                    <div className="rounded-2xl border bg-card p-8 text-center flex flex-col items-center justify-center min-h-[340px] space-y-4 shadow-sm">
                      ...
                      <div>
                        <h4 className="text-[13.5px] font-bold text-foreground">
                          SAP B1 Service Tunnel API call
                        </h4>
                    ...
                    <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm min-h-[340px] flex flex-col justify-between">
                      ...
                      <div className="p-3 bg-green-500/5 border border-green-500/20 rounded-xl text-[11.5px] font-mono leading-normal">
                        <span className="font-bold text-[#1D9E75]">• WhatsApp confirmation:</span>{" "}
                        summary dispatch receipt queued to be delivered to Rajesh Kapoor (+91 98251
                        XXXXX).
                      </div>
                    </div>
                  ) : (
                    <div className="rounded-2xl border bg-card p-8 text-center flex flex-col items-center justify-center min-h-[340px] space-y-2 shadow-sm text-muted-foreground">
                      ...
                      <p className="text-[11px]">
                        Matching records will be fetched from ERP SAP B1 Service Layer on call
                        connection.
                      </p>
                    </div>
                  )}
              ...
              <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm">
                <div>
                  <h3 className="text-[15px] font-bold text-foreground">
                    Inbound helpline Call Logs
                  </h3>
                  <p className="text-[11.5px] text-muted-foreground mt-0.5">
                    Telemetry history of routine AI handled calls
                  </p>
                </div>
          ...
          {s.id === "7-2" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Complaint Intake Helena Monitor
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Empathetic speech-to-text complaint parsing simulator
                      </p>
                    </div>
                  </div>
                  ...
                  {!m72ActiveCall ? (
                    <div className="rounded-2xl border bg-card p-8 text-center flex flex-col items-center justify-center min-h-[340px] space-y-4 shadow-sm border-dashed">
                      ...
                      <div className="space-y-1">
                        <h4 className="text-[14px] font-bold text-foreground">
                          Inbound Complaint helpline Ready
                        </h4>
                        <p className="text-[12px] text-muted-foreground max-w-sm">
                          Helpline is currently idle and ready to take customer complaints, analyze
                          call tones, and automatically register M8 tickets.
                        </p>
                      </div>
                      <button
                    ...
                    <div className="rounded-2xl border bg-card p-5 flex flex-col justify-between min-h-[340px] shadow-sm space-y-4">
                      <div className="flex justify-between items-start border-b pb-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-[13.5px] font-bold text-foreground">
                              {m72ActiveCall.account}
                            </div>
                            <span className="inline-flex items-center gap-1.5 text-[10.5px] text-muted-foreground font-mono mt-0.5">
                              {m72ActiveCall.caller} •{" "}
                              <span className="text-primary font-bold">{m72ActiveCall.lang}</span>
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3.5 text-right">
                          <div className="text-right">
                            ...
                            <span
                              className={`inline-flex px-2 py-0.25 rounded text-[11px] font-extrabold uppercase mt-0.5 ${
                                m72ActiveCall.sentiment === "Upset"
                                  ? "bg-red-500/15 text-red-500 animate-pulse font-mono"
                                  : m72ActiveCall.sentiment === "Concerned"
                          ...
                          return (
                            <div
                              ...
                              className={`p-2 rounded-xl max-w-[85%] ${
                                isAI
                                  ? "bg-primary/10 text-foreground mr-auto"
                                  : "bg-red-500/5 text-foreground ml-auto text-right border border-red-500/10"
                              }`}
                            >
                              <span className="text-[10px] font-bold text-muted-foreground block mb-0.5 uppercase">
                              ...
                              {line
                                .replace("AI Assistant (Empathy Script): ", "")
                ...
                <div className="xl:col-span-2 space-y-4">
                  <h3 className="text-[15px] font-bold text-foreground">
                    AI Parsed M8 Ticket Intake Preview
                  </h3>
                  ...
                  {m72ActiveCall ? (
                    <div className="rounded-2xl border bg-card p-5 space-y-3.5 shadow-sm min-h-[340px] flex flex-col justify-between">
                      <div className="border-b pb-3">
                        <div className="text-[13.5px] font-bold text-foreground flex items-center gap-1.5">
                          <FileText className="h-4 w-4 text-[#D85A30]" /> M8 Omnichannel Ticket
                          Intake
                        </div>
                      ...
                      <div className="space-y-2.5 font-mono text-[12px] leading-relaxed">
                        <div className="flex justify-between border-b pb-1">
                          ...
                          <span className="font-bold text-foreground">
                            {m72ActiveCall.fields.complaint_id}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-1">
                          <span className="text-muted-foreground">Defect Category:</span>
                          <span
                            className={`font-bold text-foreground ${m72ActiveCall.fields.defect_type !== "Pending..." ? "text-[#D85A30] font-black" : ""}`}
                          >
                            {m72ActiveCall.fields.defect_type}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-1">
                          <span className="text-muted-foreground">Affected Quantity:</span>
                          <span
                            className={`font-bold text-foreground ${m72ActiveCall.fields.qty !== "Pending..." ? "text-[#D85A30] font-black" : ""}`}
                          >
                            {m72ActiveCall.fields.qty}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-1">
                          <span className="text-muted-foreground">Invoice Reference:</span>
                          <span className="font-bold text-foreground">
                            {m72ActiveCall.fields.ref}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">SLA Severity Grade:</span>
                          <span
                            className={`font-extrabold ${m72ActiveCall.fields.severity === "Major" ? "text-red-500 font-black animate-pulse bg-red-500/10 px-2 py-0.25 rounded" : "text-foreground"}`}
                          >
                            {m72ActiveCall.fields.severity}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-red-500/5 border border-red-500/10 rounded-xl text-[11.5px] font-mono leading-normal text-muted-foreground">
                        <span className="font-bold text-[#D85A30]">• SLA Action Rules:</span> Major
                        severity routing commits QA deskSunita Patel to call back within 8 hours.
                      </div>
                    </div>
                  ) : (
                    <div className="rounded-2xl border bg-card p-8 text-center flex flex-col items-center justify-center min-h-[340px] space-y-2 shadow-sm text-muted-foreground">
                      ...
                      <p className="text-[11px]">
                        Structured fields parsed by NLP will display here live during complaint
                        dial-ins.
                      </p>
                    </div>
                  )}
              ...
              <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm">
                <div>
                  <h3 className="text-[15px] font-bold text-foreground">
                    Complaints Intake Ledger (today)
                  </h3>
                  <p className="text-[11.5px] text-muted-foreground mt-0.5">
                    Complaints logged via AI voice with matching M8 tickets status
                  </p>
                </div>
          ...
          {s.id === "9-3" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4">
                ...
                />
                <KpiCard
                  label="Reminders Placed Today"
                  value="312 calls"
                  delta="Helpline outbound auto"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                ...
                <KpiCard
                  ...
                  value="1 min 12 sec"
                  delta="Speech optimized script"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="PTP Fulfilment Rate"
                  value="78%"
                  delta="Target collections pace"
                  tone="success"
                  sparkline={<SparkLine />}
                />
              </div>
              ...
              <div className="rounded-2xl border bg-card p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-sm">
                <div>
                  <h3 className="text-[14px] font-bold text-foreground">
                    Outbound Payment Campaign Control
                  </h3>
                  <p className="text-[11.5px] text-muted-foreground mt-0.5">
                    Automated collection dial-outs targeting ageing receivables
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <h3 className="text-[15px] font-bold text-foreground">
                    Receivables Collections Ledger
                  </h3>
                        ...
                        {m73OverdueAccounts.map((acc) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="p-3 text-right text-foreground font-bold font-mono">
                                ₹{acc.amount.toLocaleString()}
                              </td>
                              <td className="p-3 text-center font-sans text-muted-foreground">
                                {acc.dueDate}
                              </td>
                              <td
                                className={`p-3 text-right font-bold ${isHighRisk ? "text-danger" : "text-foreground"}`}
                              >
                                {acc.daysOverdue} days
                              </td>
                              <td className="p-3 text-center font-sans">
                                <span
                                  className={`inline-block px-1.5 py-0.25 rounded text-[9.5px] font-extrabold uppercase border ${
                                    acc.status === "Commitment"
                                      ? "bg-green-500/10 text-green-500 border-green-500/20"
                                      : acc.status === "Wrong Number"
                                        ? "bg-slate-500/10 text-slate-500 border-slate-500/20"
                                        : acc.status.includes("⚠️")
                              ...
                              <td
                                className={`p-3 text-center font-extrabold ${acc.commitment !== "Pending" ? "text-success font-black" : "text-muted-foreground"}`}
                              >
                                {acc.commitment}
                              </td>
                              <td
                              ...
                              >
                                <div className="flex gap-1 justify-center">
                                  ...
                                  <button
                                    ...
                                    disabled={
                                      acc.commitment === "Escalated" ||
                                      acc.commitment === "Escalated to Credit Manager"
                                    }
                ...
                <div className="xl:col-span-2 space-y-6">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm">
                    <div className="border-b pb-3 flex justify-between items-start">
                      <div>
                        <h4 className="text-[14px] font-bold tracking-tight">
                          AI Voice Call Player
                        </h4>
                        <p className="text-[11.5px] text-muted-foreground mt-0.5">
                          Recording: {activeAccount73.account.split(",")[0]}
                        </p>
                      </div>
                      <div className="flex flex-col items-end gap-1.5 font-sans">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-bold font-mono uppercase border ${
                            activeAccount73.sentiment === "Positive"
                              ? "bg-emerald-500/10 text-emerald-600 border-emerald-500/20"
                              : activeAccount73.sentiment === "Frustrated" ||
                                  activeAccount73.sentiment === "Agitated"
                                ? "bg-red-500/10 text-red-600 border-red-500/20 animate-pulse"
                                : "bg-slate-500/10 text-slate-600 border-slate-500/20"
                          }`}
                        >
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <button
                          onClick={() => {
                            ...
                            if (nextState) {
                              toast.info(
                                `Playing call recording for ${activeAccount73.account.split(",")[0]} at ${playbackSpeed73}x speed...`,
                              );
                            } else {
                              toast.dismiss();
                            }
                        ...
                        <div className="flex items-center gap-2 bg-card px-2.5 py-1.5 rounded-lg border">
                          ...
                          />
                          <span className="text-[10.5px] font-bold font-mono w-8">
                            {playbackSpeed73.toFixed(2)}x
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-1.5 font-sans">
                      ...
                      {activeAccount73.commitment.includes("Escalated to Sales") ||
                      activeAccount73.status.includes("Dispute") ? (
                        <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-600 rounded-xl text-[11.5px] font-semibold flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-red-500/80 font-normal mt-0.5 font-mono">
                              Dispute logged: Surface quality defect on components
                            </div>
                          </div>
                        </div>
                      ) : activeAccount73.commitment.includes("Escalated to CFO") ||
                        activeAccount73.status.includes("3rd Reminder") ? (
                        <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-600 rounded-xl text-[11.5px] font-semibold flex items-start gap-2">
                          <ShieldAlert className="h-4 w-4 shrink-0 mt-0.5 animate-pulse" />
                          <div>
                            <div>Auto-routed to CFO & Direct Legal Action Desk</div>
                            <div className="text-[10px] text-red-500/80 font-normal mt-0.5 font-mono">
                              Status: Chronic stagnation threshold reached (&gt;20 days overdue)
                            </div>
                          </div>
                        </div>
                      ) : activeAccount73.status.includes("Escalated to Credit Manager") ||
                        activeAccount73.commitment === "Escalated" ? (
                        <div className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-600 rounded-xl text-[11.5px] font-semibold flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-amber-500/80 font-normal mt-0.5 font-mono">
                              Action: Suspended further shipments pending reconciliation
                            </div>
                          </div>
                        </div>
                      ) : activeAccount73.isWrongNumber ||
                        activeAccount73.commitment === "Invalid Contact" ? (
                        <div className="p-3 bg-slate-500/10 border border-slate-500/20 text-slate-600 rounded-xl text-[11.5px] font-semibold flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-slate-500/80 font-normal mt-0.5 font-mono">
                              Flagged: Customer phone contact requires validation
                            </div>
                          </div>
                        </div>
                      ) : (
                        <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 rounded-xl text-[11.5px] font-semibold flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-emerald-500/80 font-normal mt-0.5 font-mono">
                              Status: Active promise collected / standard follow-up active
                            </div>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="max-h-[180px] overflow-y-auto pr-1 space-y-2 border rounded-xl p-3 bg-muted/10 font-sans text-[12px] leading-relaxed">
                        {activeAccount73.transcript &&
                          activeAccount73.transcript.map((line, idx) => (
                            <div
                              key={idx}
                              className={`p-2 rounded-lg border ${
                                line.speaker === "Agent"
                                  ? "bg-primary/5 text-primary border-primary/10 ml-4"
                                  : "bg-card text-foreground border-muted mr-4"
                              }`}
                            >
                              <span className="font-bold text-[10.5px] block uppercase text-muted-foreground tracking-wider mb-0.5">
                                {line.speaker}
                              </span>
                              <p>{line.text}</p>
                            </div>
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm">
                    <div>
                      <h4 className="text-[14px] font-bold tracking-tight font-sans">
                        PTP Collections Calendar
                      </h4>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5 font-sans">
                        Upcoming payment commitments registered via AI voice agents
                      </p>
                    </div>
                      ...
                      {m73OverdueAccounts
                        .filter(
                          (a) =>
                            ...
                            a.commitment !== "Escalated" &&
                            a.commitment !== "Escalated to Credit Manager" &&
                            a.commitment !== "Escalated to Sales" &&
                            a.commitment !== "Escalated to CFO" &&
                            a.commitment !== "Invalid Contact" &&
                            !a.isWrongNumber,
                        )
                        .map((acc) => (
                          <div
                            key={acc.id}
                            className="p-3 rounded-xl border bg-muted/10 space-y-2 text-[12.5px] hover:border-primary/20 transition-all font-sans"
                          >
                            <div className="flex justify-between items-center">
                              <span className="font-bold text-foreground">
                                {acc.account.split(",")[0]}
                              </span>
                              <span className="font-mono text-primary font-bold text-[11.5px]">
                                {acc.invoice}
                              </span>
                            </div>
                    ...
                    <div className="p-3 bg-primary/5 border border-primary/10 rounded-xl text-[11px] font-mono leading-normal text-muted-foreground mt-4 font-sans">
                      <span className="font-bold text-primary block mb-1 font-sans">
                        • PTP Tracking Protocol:
                      </span>
                      Once a date commitment is logged, automated follow-up calls are paused until
                      that date, after which reconciliation is automatically checked.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-4">
                ...
                <KpiCard
                  ...
                  value="7.4 / 10"
                  delta="Rolling 90 days NPS"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Promoters share"
                  value="42%"
                  delta="NPS score 9-10"
                  tone="success"
                  sparkline={<SparkLine />}
                />
                <KpiCard
                  label="Passives share"
                  value="33%"
                  delta="NPS score 7-8"
                  tone="success"
                  sparkline={<SparkLine />}
                ...
                <KpiCard
                  ...
                  value="4 campaigns"
                  delta="Trigger: post-delivery M5"
                  tone="success"
                  sparkline={<SparkLine />}
                />
              </div>
              ...
              <div className="rounded-2xl border bg-card p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-sm">
                <div>
                  <h3 className="text-[14px] font-bold text-foreground">
                    Dealer NPS Campaigns Monitor
                  </h3>
                  <p className="text-[11.5px] text-muted-foreground mt-0.5">
                    Proactive monthly NPS survey campaigns via outbound AI voice calls
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <h3 className="text-[15px] font-bold text-foreground">
                    Dealer Satisfaction Index Scoreboard
                  </h3>
                        ...
                        {m74Dealers.map((d) => {
                          ...
                          return (
                            <tr key={d.id} className="hover:bg-muted/30 transition-colors">
                              ...
                              <td className="p-3 text-center font-extrabold font-mono text-[13.5px]">
                                {d.score}
                              </td>
                              <td className="p-3 text-center font-sans">
                                <span
                                  className={`inline-block px-1.5 py-0.25 rounded text-[10px] font-extrabold uppercase ${
                                    isPromoter
                                      ? "bg-green-500/10 text-green-500"
                                      : isDetractor
                                        ? "bg-red-500/10 text-red-500 animate-pulse font-black"
                              ...
                              <td className="p-3 text-foreground font-sans text-[11.5px] line-clamp-2 max-w-xs">
                                {d.feedback}
                              </td>
                              <td className="p-3 text-center font-sans">
                                {isDetractor &&
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4 shadow-sm min-h-[360px]">
                    <div className="space-y-1">
                      <h4 className="text-[13px] font-bold text-foreground">
                        Top Complaint & Satisfaction Themes
                      </h4>
                      <p className="text-[11px] text-muted-foreground">
                        NLP theme tagging from open speech dialogs
                      </p>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-primary/10 via-primary/5 to-card shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      Intake Channel Health: 5 Channels Active & Online
                    </div>
                    <div className="text-[12px] text-muted-foreground font-mono">
                      Today: 7 complaints received • Oldest unacknowledged: 0 hrs 14 min • SLA: 100%
                      compliant
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-[15px] font-bold text-foreground">
                        Unified Complaints Inbox Feed
                      </h3>
                      <p className="text-[11.5px] text-muted-foreground mt-0.5">
                        Chronological record of all complaints logged today across channels
                      </p>
                    </div>
                  </div>
                            ...
                            <td className="p-3 text-center">
                              <span
                                className={`inline-block px-1.5 py-0.5 rounded text-[9.5px] font-bold uppercase ${
                                  c.severity === "Critical"
                                    ? "bg-red-500/15 text-red-500 animate-pulse font-black"
                                    : c.severity === "Major"
                ...
                <div className="xl:col-span-2 space-y-4">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4 min-h-[340px]">
                    <div className="space-y-1">
                      <h4 className="text-[13px] font-bold text-foreground">
                        Performance telemetry by Channel
                      </h4>
                      <p className="text-[11px] text-muted-foreground">
                        Rolling 7 days response speed and volume
                      </p>
                    </div>
                    ...
                    <div className="space-y-3 font-mono text-[12px]">
                      {m81ChannelStats.map((c, idx) => (
                        <div key={idx} className="flex justify-between items-center border-b pb-2">
                          ...
                          <span className="font-bold text-foreground">
                            {c.today} today{" "}
                            <span className="text-muted-foreground font-normal">({c.week} wk)</span>
                          </span>
                          <span className="text-[#1D9E75] font-extrabold">
                            {c.avgResponse} response
                          </span>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="p-3 bg-primary/5 border border-primary/10 rounded-xl text-[11.5px] font-mono leading-normal text-muted-foreground mt-4">
                      <span className="font-bold text-primary block mb-1">
                        • OCR & NLP parsing summary:
                      </span>
                      AI extracts customer name, order reference, defect category, and quantity
                      affected automatically on arrival.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-primary/10 via-primary/5 to-card shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      Classification Queue: 0 Pending
                    </div>
                    <div className="text-[12px] text-muted-foreground font-mono">
                      Average classification time today: 5.8 seconds • Classification accuracy: 94%
                      YTD
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                    ...
                    <table className="w-full text-left text-[12px] font-mono">
                      ...
                      <tbody className="divide-y">
                        {m82ClassificationLog.map((c) => (
                          <tr key={c.id} className="hover:bg-muted/30 transition-colors">
                            <td className="p-3">
                              <span className="font-extrabold text-[#D85A30] block">
                                {c.complaintId}
                              </span>
                ...
                <div className="xl:col-span-2 space-y-4">
                  ...
                  <div className="rounded-2xl border bg-card p-5 space-y-4 min-h-[360px]">
                    <div className="space-y-1">
                      <h4 className="text-[13px] font-bold text-foreground">
                        Defect Category Assignees
                      </h4>
                      <p className="text-[11px] text-muted-foreground">
                        Automatic routing path configured in rules engine
                      </p>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-primary/10 via-primary/5 to-card shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      Acknowledgements: 100% Sent Within SLA
                    </div>
                    <div className="text-[12px] text-muted-foreground font-mono">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <h3 className="text-[15px] font-bold text-foreground">
                    Customer Acknowledgement Telemetry Log
                  </h3>
                          ...
                          <tr key={c.id} className="hover:bg-muted/30 transition-colors">
                            ...
                            <td className="p-3 text-center">
                              <div className="flex items-center justify-center gap-1.5 text-muted-foreground">
                                ...
                                {c.read ? (
                                  <span className="text-[11px] text-green-500 font-extrabold">
                                    ✓ Read
                                  </span>
                                ) : (
                                  <span>-</span>
...
— Fortiv ManufactureSmart Customer Service`}
                    ...
                    <div className="p-3 bg-red-500/5 border border-red-500/10 rounded-xl text-[11.5px] font-mono leading-normal text-muted-foreground">
                      <span className="font-bold text-[#D85A30] block mb-1">
                        • Business Logic Rule:
                      </span>
                      Acknowledgement channels match the intake channel (WhatsApp for WhatsApp,
                      Email for Email) with a 5-minute hard constraint.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                <div className="rounded-2xl bg-card border p-4">
                  ...
                  <div className="text-[20px] font-bold font-mono text-foreground mt-1">
                    5 CAPAs
                  </div>
                ...
                <div className="rounded-2xl bg-card border p-4">
                  ...
                  <div className="text-[20px] font-bold font-mono text-[#1D9E75] mt-1">
                    14 closed
                  </div>
                  <div className="text-[10px] text-muted-foreground mt-0.5">
                    Avg closure: 11.2 days
                  </div>
                </div>
                        ...
                        {m84Capas.map((c) => (
                          <tr key={c.id} className="hover:bg-muted/30 transition-colors">
                            <td className="p-3">
                              ...
                              <span className="text-[10px] text-muted-foreground font-sans mt-0.5">
                                {c.customer} ({c.complaintId})
                              </span>
                            </td>
                            <td className="p-3">
                              <span className="font-bold text-foreground">{c.defect}</span>
                              <span
                                className={`block text-[9.5px] font-bold uppercase mt-0.5 ${
                  ...
                  <div className="rounded-2xl border bg-red-500/5 border-red-500/10 p-5 space-y-4 flex flex-col justify-between min-h-[360px]">
                    <div className="space-y-2">
                      <div className="text-[13px] font-extrabold text-red-500 flex items-center gap-2">
                        <AlertTriangle className="h-4 w-4 animate-bounce" /> 3+ Complaints in 90
                        Days Detected
                      </div>
                      <h4 className="text-[14px] font-bold text-foreground">
                        Surface Finish Defects (CRCA Material)
                      </h4>
                      <p className="text-[11.5px] text-muted-foreground font-sans leading-relaxed">
                        Recurring surface defect pattern identified on raw material sheet lot. CAPA
                        actions for CMP-388 and CMP-402 have not prevented recurrence.
                      </p>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-primary/10 via-primary/5 to-card shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <div className="text-[13px] font-bold text-foreground">
                      Resolution Updates Active: CMP-2024-441
                    </div>
                    <div className="text-[12px] text-muted-foreground font-mono">
                      Updates sent today: 14 • Open complaints with pending update: 1 • Avg
                      resolution CSAT: +29 NPS
                    </div>
                  </div>
                </div>
                <button
              ...
              <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
                ...
                <div className="xl:col-span-3 space-y-4">
                  <h3 className="text-[15px] font-bold text-foreground">
                    Complaint Lifecycle Milestone Timeline
                  </h3>
                    ...
                    <div className="relative border-l pl-6 space-y-4 font-mono text-[12px]">
                      {m85Timeline.map((t) => (
                        <div key={t.id} className="relative">
                          {/* Timeline Dot */}
                          <div
                            className={`absolute -left-[30px] top-1 h-3.5 w-3.5 rounded-full border-2 bg-card ${
                              t.status === "Pending"
                                ? "border-amber-500 bg-amber-500/25 animate-pulse"
                          ...
                          <div className="flex items-center justify-between text-muted-foreground mb-0.5">
                            ...
                            <span className="text-[10px] uppercase font-bold text-primary font-sans bg-primary/10 px-1.5 py-0.25 rounded">
                              {t.status}
                            </span>
                          </div>
                          <div className="font-sans text-[13px] font-bold text-foreground">
                            {t.event}
                          </div>
                        ...
                        {m85NpsScores.map((s) => {
                          ...
                          return (
                            <tr key={s.id} className="hover:bg-muted/30 transition-colors">
                              ...
                              <td className="p-3 text-center font-extrabold text-[13px]">
                                {s.score}
                              </td>
                              <td className="p-3 text-center">
                                <span
                                  className={`inline-block px-1.5 py-0.25 rounded text-[9.5px] font-extrabold uppercase ${
                                    s.category === "Promoter"
                                      ? "bg-green-500/10 text-green-500"
                                      : s.category === "Detractor"
                                        ? "bg-red-500/10 text-red-500 animate-pulse"
                                        : "bg-blue-500/10 text-blue-500"
                                  }`}
                                >
                              ...
                              <td className="p-3 text-center">
                                {isDetractor ? (
                                  s.flagged ? (
                                    <span className="text-[10px] font-bold text-red-500 font-sans">
                                      Flagged
                                    </span>
                                  ) : (
                                    <button
                                  ...
                                  <span className="text-muted-foreground text-[10.5px] font-sans">
                                    Closed
                                  </span>
                                )}
                              </td>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      12-Month Complaint Trend & Moving Avg
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Total complaint count per month with 3-month rolling average
                    </p>
                  </div>
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      Defect Type Pareto Analysis (MTD)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Defect type counts sorted by frequency with cumulative contribution
                    </p>
                  </div>
                  <div className="h-[250px]">
                    <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      Complaint Cost Breakdown MTD (₹3.8L)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Value of replacements, credit notes, rework and QA audit hours
                    </p>
                  </div>
                  <div className="h-[250px] flex items-center justify-between">
                    ...
                    <div className="w-[45%] space-y-2 font-mono text-[11px]">
                      {m86CostBreakdown.map((c, idx) => {
                        const colors = ["var(--color-chart-2)", "var(--color-primary)", "var(--color-warning)", "var(--color-chart-4)"];
                        return (
                ...
                <div className="rounded-2xl border bg-card p-5 space-y-4 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[15px] font-bold text-foreground">
                      Customer Quality Heatmap (90 Days)
                    </h3>
                    <p className="text-[11.5px] text-muted-foreground mt-0.5">
                      Aggregated feedback indicators and resolution speeds by buyer account
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pt-3 border-t">
                    <span className="text-[11px] text-muted-foreground font-mono">
                      Last digest sent: 1st Monday, Feb 2025
                    </span>
                    <button
          ...
          <div className="rounded-2xl border px-5 py-3 bg-card flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px]">
            {s.kpis.map((k: any, i: number) => (
              <span key={k.label} className="flex items-center gap-1.5">
                ...
                <span className="font-semibold text-foreground">
                  {k.label} <span className="font-mono text-primary ml-1">{k.value}</span>
                </span>
              </span>
            ))}
          </div>
          ...
          <DataCard
            ...
            action={
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => toast.info(`Adding new record item to ${s.title}...`)}
                  className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg bg-primary text-primary-foreground text-[12px] font-medium hover:opacity-90 transition-all"
                >
