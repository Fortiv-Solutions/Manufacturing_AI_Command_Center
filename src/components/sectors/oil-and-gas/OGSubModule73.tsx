...
export function OGSubModule73() {
  ...
  const [registerCategory, setRegisterCategory] = useState<
    "scope1" | "scope2" | "water" | "waste" | "social"
  >("scope1");
  ...
  const handleGenerateBRSRPDF = () => {
    toast.loading(
      "Gathering audit certificates and generating SEBI-compliant BRSR disclosure pack...",
    );
    setTimeout(() => {
      toast.dismiss();
      toast.success(
        "BRSR Disclosure compiled successfully! Q2 report and GRI audit log exported as PDF.",
      );
    }, 2000);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            value: "248 tCO2e",
            sub: "Grid Electricity (CEA factor)",
            color: "#1A6B8A",
            bg: "bg-blue-50",
          ...
          },
          {
            ...
            value: "89%",
            sub: "Scope 3 under consolidation",
            color: "#0F7B6C",
            bg: "bg-[#E3F4F2]",
            border: "border-[#0F7B6C]/10",
          },
          {
            label: "BRSR Filing Status",
            value: "76% Complete",
            sub: "FY 2024-25 Disclosure",
            color: "#C8922A",
            bg: "bg-[#F5F0E8]",
            border: "border-[#C8922A]/10",
            pulse: true,
          },
        ].map((kpi) => (
          <div
            key={kpi.label}
            className={`rounded-2xl border ${kpi.border} bg-white p-4 shadow-sm flex items-center gap-3`}
          >
            <div
            ...
            >
              {kpi.color === "#0F7B6C" ? (
                ...
                <ClipboardList
                  className={`h-5.5 w-5.5 text-[#C8922A] ${kpi.pulse ? "animate-pulse" : ""}`}
                />
              ) : kpi.color === "#C0392B" ? (
      ...
      {activeTab === "register" && (
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-3 border border-[#D1D9E3] rounded-2xl p-4 bg-slate-50/20 space-y-2">
            <h4 className="text-[10px] font-bold text-[#1A6B8A] uppercase tracking-wider mb-3">
              Categories
            </h4>
            {[
              ...
              <button
                ...
                className={`w-full text-left p-2.5 rounded-xl text-xs font-semibold transition-all ${
                  registerCategory === cat.id
                    ? "bg-white border border-[#D1D9E3] shadow-sm text-[#0D1B2A]"
                    : "hover:bg-slate-50 text-[#8892A0]"
                }`}
              >
                {cat.label}
              </button>
          ...
          <div className="lg:col-span-7 border border-[#D1D9E3] rounded-2xl bg-white shadow-sm overflow-hidden p-5 space-y-4">
            <div className="border-b pb-3 flex items-center justify-between">
              ...
              <Badge className="bg-blue-50 text-[#1A6B8A] border-blue-200 border text-[9px] font-bold">
                Auto-Populated
              </Badge>
            </div>
            ...
            {registerCategory === "scope1" && (
              <div className="space-y-4 text-xs">
                {[
                  {
                    name: "Diesel combustion (Generators & Vehicles)",
                    val: dieselValue,
                    code: "diesel",
                    src: "Fuel consumption log (19.4 lakh L)",
                    conf: 96,
                  },
                  {
                    name: "Gas flaring",
                    val: flaringValue,
                    code: "flaring",
                    src: "Flaring register (847 MMSCF flared)",
                    conf: 94,
                  },
                  {
                    name: "Fugitive methane emissions",
                    val: "312 tCO2e",
                    src: "Equipment counts (AP-42 factors)",
                    conf: 91,
                  },
                  {
                    name: "Process venting",
                    val: "94 tCO2e",
                    src: "Venting log registers",
                    conf: 89,
                  },
                ].map((metric) => (
                  <div
                    key={metric.name}
                    className="p-3.5 border border-[#D1D9E3] rounded-xl flex items-center justify-between hover:bg-slate-50 transition-colors"
                  >
                    <div className="space-y-1">
                      <p className="font-bold text-[#0D1B2A]">{metric.name}</p>
                      <p className="text-[10px] text-[#8892A0]">
                        Source: <strong className="font-mono">{metric.src}</strong> | Confidence:{" "}
                        <span className="font-mono text-[#0F7B6C]">{metric.conf}%</span>
                      </p>
                    </div>
              ...
              <div className="space-y-4 text-xs">
                <div className="p-3.5 border border-[#D1D9E3] rounded-xl flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-[#8892A0]">
                      Source:{" "}
                      <strong className="font-mono">CEA India factor (0.82 t/MWh) × 302 MWh</strong>
                    </p>
                  </div>
            ...
            {registerCategory === "water" && (
              <div className="space-y-4 text-xs">
                {[
                  {
                    name: "Fresh water consumed",
                    val: "14,200 kL",
                    src: "Water flowmeter records (Intensity: 0.11 kL/bbl)",
                  },
                  {
                    name: "Recycled / reused water",
                    val: "8,900 kL",
                    src: "Treatment logs (62.7% of total)",
                  },
                  {
                    name: "Wastewater discharged",
                    val: "3,400 kL",
                    src: "Treatment plant discharge registers",
                  },
                ].map((metric) => (
                  <div
                    key={metric.name}
                    className="p-3.5 border border-[#D1D9E3] rounded-xl flex items-center justify-between"
                  >
                    <div className="space-y-1">
                      <p className="font-bold text-[#0D1B2A]">{metric.name}</p>
                      <p className="text-[10px] text-[#8892A0]">
                        Source: <strong className="font-mono">{metric.src}</strong>
                      </p>
                    </div>
                ...
                {[
                  {
                    ...
                    val: "84.3 MT",
                    src: "Waste manifests / CPCB logs",
                  },
                  { name: "Drilling cuttings", val: "312 MT", src: "TSD disposal certificates" },
                  {
                    name: "Produced water volume",
                    val: "6,240 bbl/d",
                    src: "100% reinjection records",
                  },
                ].map((metric) => (
                  <div
                    key={metric.name}
            ...
            {registerCategory === "social" && (
              <div className="space-y-4 text-xs">
                {[
                  {
                    name: "Total Safety Training hours",
                    val: "2,847 hours",
                    src: "HSE Training logs (Avg 20.1 hrs/person)",
                  },
                  {
                    name: "LTI Rate (Man-hours)",
                    val: "0.00 (Zero LTI)",
                    src: "M3 HSE Safety reports",
                  },
                  {
                    name: "Workforce Gender Ratio",
                    val: "17% Female / 83% Male",
                    src: "HR Employee registers",
                  },
                ].map((metric) => (
                  <div
                    key={metric.name}
      ...
      {activeTab === "calculator" && (
        <div className="rounded-2xl border border-[#D1D9E3] bg-white p-5 shadow-sm space-y-4">
          <div className="border-b pb-3 flex items-center justify-between">
            ...
            <Badge className="bg-[#E3F4F2] text-[#0F7B6C] border-[#0F7B6C]/20 border text-[9px] font-bold">
              IPCC AR6 Factors
            </Badge>
          </div>
              ...
              <div className="divide-y divide-[#D1D9E3] text-[11px]">
                <div className="py-2.5 flex items-center justify-between">
                  <span>
                    ...
                    <code className="bg-slate-100 px-1 rounded font-mono">
                      Litres consumed (19.4 lakh L) × 2.67 kgCO2e/L
                    </code>
                  </span>
                ...
                <div className="py-2.5 flex items-center justify-between">
                  <span>
                    Gas flaring:{" "}
                    <code className="bg-slate-100 px-1 rounded font-mono">
                      MMSCF flared (847) × 1.42 tCO2e/MMSCF
                    </code>
                  </span>
                ...
                <div className="py-2.5 flex items-center justify-between">
                  <span>
                    Fugitive methane:{" "}
                    <code className="bg-slate-100 px-1 rounded font-mono">
                      Equipment tags × AP-42 Activity factors × GWP 28
                    </code>
                  </span>
            ...
            <div className="p-4 border border-[#D1D9E3] rounded-xl bg-slate-50/20 space-y-3">
              ...
              <div className="text-[11px] flex items-center justify-between">
                <span>
                  ...
                  <code className="bg-slate-100 px-1 rounded font-mono">
                    CEA grid factor (0.82 tCO2e/MWh) × 302 MWh
                  </code>
                </span>
            ...
            {[
              ...
              <button
                ...
                className={`w-full text-left p-2 rounded-xl text-[11px] font-semibold transition-all border ${
                  brsrPrinciple === pr.id
                    ? "bg-white border-[#D1D9E3] shadow-sm text-[#0D1B2A]"
                    : "hover:bg-slate-50 border-transparent text-[#8892A0]"
                }`}
              >
            ...
            {brsrPrinciple === 6 ? (
              <div className="space-y-4 text-xs font-sans">
                <div className="p-3 border border-[#D1D9E3] rounded-xl bg-slate-50/20 space-y-1">
                  ...
                  <p className="text-[11px] text-[#0D1B2A]/90 pt-1">
                    Total energy consumed from non-renewable sources: 519 TJ (diesel + grid
                    electricity)
                  </p>
                  <p className="text-[11px] text-[#0D1B2A]/90">
                    Energy intensity: 4.05 GJ per barrel produced
                  </p>
                  <p className="text-[9.5px] text-[#8892A0] pt-1">
                    Data Source: Fuel logs + CEA grid factors | Confidence: 96%
                  </p>
                </div>
                ...
                <div className="p-3 border border-[#D1D9E3] rounded-xl bg-slate-50/20 space-y-1">
                  ...
                  <p className="text-[11px] text-[#0D1B2A]/90 pt-1">
                    Water withdrawn: 14,200 kL (Intensity: 0.11 kL/bbl)
                  </p>
                  <p className="text-[11px] text-[#0D1B2A]/90">
                    Water recycled or reused: 8,900 kL (62.7% of total)
                  </p>
                  <p className="text-[9.5px] text-[#8892A0] pt-1">
                    Data Source: Flowmeter records | Confidence: 94%
                  </p>
                </div>
              ...
              <div className="p-10 text-center text-xs text-[#8892A0] italic">
                Principle {brsrPrinciple} auto-populated data draft is currently being parsed from
                ERP records.
              </div>
            )}
          </div>
      ...
      {activeTab === "tracker" && (
        <div className="rounded-2xl border border-[#D1D9E3] bg-white shadow-sm overflow-hidden">
          <div className="p-4 border-b border-[#D1D9E3] bg-slate-50/50">
            <h3 className="text-xs font-bold text-[#1A6B8A] uppercase tracking-wider">
              ESG Regulatory Filings Tracker
            </h3>
          </div>
          ...
          <div className="overflow-x-auto text-xs">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-slate-100">
                {[
                  {
                    type: "BRSR Disclosure",
                    auth: "SEBI / Exchange",
                    freq: "Annual",
                    date: "31 Mar 2026",
                    status: "76% Complete",
                    bad: "bg-amber-50 text-amber-700 border-amber-200",
                  },
                  {
                    type: "Annual Environmental Statement (Form-V)",
                    auth: "MoEFCC via CPCB",
                    freq: "Annual",
                    date: "30 Sep 2026",
                    status: "Data Collection",
                    bad: "bg-blue-50 text-[#1A6B8A] border-blue-200",
                  },
                  {
                    type: "Hazardous Waste Annual Return",
                    auth: "CPCB",
                    freq: "Annual",
                    date: "30 Jun 2026",
                    status: "Scheduled",
                    bad: "bg-slate-100 text-slate-500 border-slate-200",
                  },
                  {
                    type: "Consent to Operate Renewal",
                    auth: "State PCB",
                    freq: "As Required",
                    date: "15 Mar 2026",
                  ...
                  <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-center">
                      <Badge className={`${row.bad} border text-[9px] font-bold`}>
      ...
      <div className="flex items-center justify-between rounded-2xl border border-[#D1D9E3] bg-white p-4 shadow-sm">
        ...
        <span className="text-[10px] text-[#8892A0] font-mono">
          SEBI Compliant Disclosure Generator • CEA Grid Factor v2024
        </span>
      </div>
    </div>
  );
