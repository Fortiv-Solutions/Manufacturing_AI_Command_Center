...
export function OGSubModule21() {
  ...
  const [documents, setDocuments] = useState<IngestItem[]>([
    {
      name: "KG-DWN-98_3_Block_Lease_Agreement.pdf",
      size: "4.8 MB",
      pages: 48,
      status: "Needs Review",
      type: "PDF",
    ...
    {
      name: "CB-ONN-2010_1_Surface_Rights_2010.pdf",
      size: "2.1 MB",
      pages: 24,
      status: "Extracted",
      type: "PDF",
    ...
    {
      name: "RJ-ONN-2015_1_Seismic_Contract.pdf",
      size: "1.4 MB",
      pages: 12,
      status: "Processing",
      type: "PDF",
  ...
  const [fields, setFields] = useState<ExtractedField[]>([
    {
      category: "Parties",
      key: "Lessor Name",
      value: "Government of India, MoPNG",
      confidence: 100,
      source: "Page 1, Preamble",
    },
    {
      category: "Parties",
      key: "Lessee Name",
    ...
    },
    {
      ...
      value: "KG-DWN-98/3",
      confidence: 100,
      source: "Page 1, Clause 1.1",
    },
    {
      category: "Block Details",
      key: "Location",
      value: "Krishna Godavari Basin, Offshore Deepwater",
      confidence: 99,
      source: "Page 2, Schedule A",
    },
    {
      category: "Block Details",
      key: "Acreage",
    ...
    {
      category: "Term & Phases",
      key: "Effective Date",
      value: "15 March 1998",
      confidence: 100,
      source: "Page 1, Clause 2.1",
    },
    {
      category: "Term & Phases",
      key: "Phase 1 duration",
      value: "3 years",
      confidence: 99,
    ...
    {
      category: "Term & Phases",
      key: "Phase 2 duration",
      value: "2 years",
      confidence: 98,
      source: "Page 5, Clause 3.3",
    },
    {
      category: "Term & Phases",
      key: "Development Period",
      value: "25 years on commercial discovery",
      confidence: 96,
      source: "Page 6, Clause 4.2",
    },
    {
      category: "Financial",
      key: "Royalty (Crude)",
      value: "10% — deepwater rate",
      confidence: 99,
      source: "Page 11, Clause 7.1",
    },
    {
      category: "Financial",
      key: "Royalty (Gas)",
    ...
    {
      category: "Financial",
      key: "Cost Recovery Cap",
      value: "90%",
      confidence: 97,
      source: "Page 18, Clause 8.4",
    },
    {
      category: "Financial",
      key: "Surface Rental",
      value: "",
      confidence: 61,
      source: "Page 12, Clause 7.5",
      flagged: true,
      errorMsg: "Figure illegible in scanned document",
    },
    {
      category: "Work Programme",
      key: "Phase 1 Well Commitment",
      value: "2 wells minimum",
      confidence: 98,
      source: "Page 9, Clause 5.3",
    },
    {
      category: "Work Programme",
      key: "Seismic Commitment",
      value: "500 sq km 3D seismic",
      confidence: 96,
      source: "Page 9, Clause 5.2",
    },
    {
      category: "Assignment",
      key: "Assignment Rights",
      value: "Prior GOI approval required",
      confidence: 99,
      source: "Page 31, Clause 14.1",
    },
    {
      ...
      value: "",
      confidence: 68,
      source: "Page 37, Clause 19.1",
      flagged: true,
      errorMsg: "Clause text partially obscured by stamp",
    },
    {
      category: "Dispute Resolution",
      key: "Arbitration Seat",
      value: "",
      confidence: 72,
      source: "Page 38, Clause 19.2",
      flagged: true,
      errorMsg: "Arbitration seat requires verification",
    },
  ]);
      ...
      <div className="lg:col-span-4 space-y-6 flex flex-col">
        ...
        <div className="rounded-2xl border border-[#D1D9E3] bg-white p-5 shadow-sm space-y-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[11px] text-[#8892A0]">
              Drop scanned lease agreements, PSCs, or RSC contracts.
            </p>
          </div>
          ...
          <div className="border border-dashed border-[#D1D9E3] bg-[#F5F6FA] hover:bg-slate-50 transition-colors rounded-xl p-5 text-center cursor-pointer relative">
            ...
            <p className="text-[11.5px] font-semibold text-[#0D1B2A]">
              Upload scanned PDF agreements
            </p>
            <p className="text-[9.5px] text-[#8892A0] mt-0.5">
              Supports high-sensitivity legacy OCR
            </p>
          </div>
        ...
        <div className="rounded-2xl border border-[#D1D9E3] bg-white p-5 shadow-sm flex-1 flex flex-col space-y-3">
          <div className="flex items-center justify-between border-b pb-2 mb-1">
            <h4 className="text-[12.5px] font-bold text-[#0D1B2A] uppercase tracking-wider font-mono">
              Lease Documents
            </h4>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <span
                      className="text-[12px] font-medium text-[#0D1B2A] truncate"
                      title={doc.name}
                    >
                      {doc.name}
                    </span>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <p className="text-[11.5px] text-[#8892A0]">
                  Category:{" "}
                  <span className="font-semibold text-[#1A6B8A]">Production Sharing Contract</span>{" "}
                  • Status: <span className="font-semibold text-[#1A6B8A]">Needs Review</span>
                </p>
              </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-[11px] font-medium">
                ...
                <span className="font-mono text-[#0D1B2A] font-bold">
                  {countFilled}/{totalFields} fields complete (
                  {Math.round((countFilled / totalFields) * 100)}%)
                </span>
              </div>
              <Progress
              ...
              <div className="space-y-4 font-sans text-xs">
                ...
                {Array.from(new Set(fields.map((f) => f.category))).map((cat) => (
                  <div key={cat} className="space-y-2">
                    <h4 className="text-[10px] font-bold text-[#1A6B8A] uppercase tracking-wider border-b pb-1 font-mono">
                      {cat}
                    </h4>
                              ...
                              {!field.flagged ? (
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Badge
                                      className={`border text-[9px] font-mono font-medium px-1.5 py-0 rounded-sm hover:opacity-90 ${getConfidenceStyle(field.confidence)}`}
                                    >
                                      {field.confidence}%
                                    </Badge>
                                  </TooltipTrigger>
                                  <TooltipContent className="bg-[#0D1B2A] border-none text-white text-[10px] p-2.5 rounded-lg shadow-lg">
                                    <div className="space-y-1">
                                      <p className="font-bold text-[#C8922A]">
                                        AI OCR Mapping Source
                                      </p>
          ...
          <div className="p-4 border-t border-[#D1D9E3] bg-white flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <Button
                ...
                onClick={() => {
                  toast.success(
                    "Structural lease terms saved! Obligation calendar and anomaly registers updated.",
                  );
                }}
